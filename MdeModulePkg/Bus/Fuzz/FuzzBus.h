...
#include "FuzzBusProtocol.h"

#define PCI_VENDOR_ID_QEMU               0x1234

#define FUZZ_BUS_PRIVATE_DATA_SIGNATURE   SIGNATURE_32 ('F', 'B', 'P', 'D')

typedef struct {
  UINT32                  Signature;
  FUZZ_BUS_PROTOCOL       FuzzBus;
  EFI_PCI_IO_PROTOCOL     *PciIo;
  UINT32                  IntVector;
  UINT64                  OriginalPciAttributes;
} FUZZ_BUS_PRIVATE_DATA;

#define FUZZ_BUS_PRIVATE_DATA_FROM_FUZZ_BUSS(a) \
    CR (a, FUZZ_BUS_PRIVATE_DATA, FuzzBus, FUZZ_BUS_PRIVATE_DATA_SIGNATURE)

#define EFI_EDU_BAR_INDEX                     0x0

// Fuzz Bus Adaptor IRQ is 11 on q35, and 10 on 440BX 
#define FUZZ_BUS_IRQ   11
