...
//
extern void *EFI_UsbMassStorageDxe_TypeInfoList[];
void **ToMergeTypeInfoList[] = {
  EFI_UsbMassStorageDxe_TypeInfoList,
  NULL
};

extern FUNCTION_TYPE_MAP EFI_UsbMassStorageDxe_FunctionTypeMapList[];
FUNCTION_TYPE_MAP *ToMergeFunctionTypeMapList[] = {
  EFI_UsbMassStorageDxe_FunctionTypeMapList,
  NULL
};
