...
__declspec(allocate(".SCOV$CA")) long long __start___sancov_cntrs = 0;
...
__declspec(allocate(".SCOV$CZ")) __declspec(align(1)) unsigned char
    __stop___sancov_cntrs = 0;

#pragma section(".SCOV$GA", read, write)
__declspec(allocate(".SCOV$GA")) long long __start___sancov_guards = 0;

#pragma section(".SCOV$GZ", read, write)
__declspec(allocate(".SCOV$GZ")) __declspec(align(1)) unsigned char
...
__declspec(allocate(".SCOVP$A")) long long __start___sancov_pcs = 0;
#pragma section(".SCOVP$Z", read)
__declspec(allocate(".SCOVP$Z")) __declspec(align(1)) unsigned char
