...
typedef struct _TYPE__EFI_DISK_IO_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
...
} TYPE__EFI_DISK_IO_PROTOCOL;

TYPE__EFI_DISK_IO_PROTOCOL TypeInfo__EFI_DISK_IO_PROTOCOL = {
  .TypeName = "EFI_DISK_IO_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_DISK_IO_PROTOCOL),
  .StructFieldNum = 3,
  .StructFieldName_1 = "Revision",
  .StructFieldTypeName_1 = "UINT64",
  .StructFieldName_2 = "ReadDisk",
  .StructFieldTypeName_2 = "EFI_DISK_READ",
  .StructFieldName_3 = "WriteDisk",
  .StructFieldTypeName_3 = "EFI_DISK_WRITE"
};
...
typedef struct _TYPE__EFI_DISK_READ{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
...
TYPE__EFI_DISK_READ TypeInfo__EFI_DISK_READ = {
  .TypeName = "EFI_DISK_READ",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_DISK_READ),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 5,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_DISK_IO_PROTOCOL*",
...
typedef struct _TYPE__EFI_DISK_IO_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_DISK_IO_PROTOCOL_STAR;

TYPE__EFI_DISK_IO_PROTOCOL_STAR TypeInfo__EFI_DISK_IO_PROTOCOL_STAR = {
  .TypeName = "EFI_DISK_IO_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_DISK_IO_PROTOCOL*),
  .PointedType = "EFI_DISK_IO_PROTOCOL"
};
...
typedef struct _TYPE__EFI_DISK_WRITE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_5;
  const CHAR8* ParameterTypeName_5;
} TYPE__EFI_DISK_WRITE;

TYPE__EFI_DISK_WRITE TypeInfo__EFI_DISK_WRITE = {
  .TypeName = "EFI_DISK_WRITE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_DISK_WRITE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 5,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_DISK_IO2_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
...
} TYPE__EFI_DISK_IO2_PROTOCOL;

TYPE__EFI_DISK_IO2_PROTOCOL TypeInfo__EFI_DISK_IO2_PROTOCOL = {
  .TypeName = "EFI_DISK_IO2_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_DISK_IO2_PROTOCOL),
  .StructFieldNum = 5,
  .StructFieldName_1 = "Revision",
  .StructFieldTypeName_1 = "UINT64",
  .StructFieldName_2 = "Cancel",
  .StructFieldTypeName_2 = "EFI_DISK_CANCEL_EX",
  .StructFieldName_3 = "ReadDiskEx",
  .StructFieldTypeName_3 = "EFI_DISK_READ_EX",
  .StructFieldName_4 = "WriteDiskEx",
  .StructFieldTypeName_4 = "EFI_DISK_WRITE_EX",
  .StructFieldName_5 = "FlushDiskEx",
  .StructFieldTypeName_5 = "EFI_DISK_FLUSH_EX"
};


typedef struct _TYPE__EFI_DISK_CANCEL_EX{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_1;
  const CHAR8* ParameterTypeName_1;
} TYPE__EFI_DISK_CANCEL_EX;

TYPE__EFI_DISK_CANCEL_EX TypeInfo__EFI_DISK_CANCEL_EX = {
  .TypeName = "EFI_DISK_CANCEL_EX",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_DISK_CANCEL_EX),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 1,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_DISK_IO2_PROTOCOL*"
};


typedef struct _TYPE__EFI_DISK_IO2_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_DISK_IO2_PROTOCOL_STAR;

TYPE__EFI_DISK_IO2_PROTOCOL_STAR TypeInfo__EFI_DISK_IO2_PROTOCOL_STAR = {
  .TypeName = "EFI_DISK_IO2_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_DISK_IO2_PROTOCOL*),
  .PointedType = "EFI_DISK_IO2_PROTOCOL"
};


typedef struct _TYPE__EFI_DISK_READ_EX{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
...
} TYPE__EFI_DISK_READ_EX;

TYPE__EFI_DISK_READ_EX TypeInfo__EFI_DISK_READ_EX = {
  .TypeName = "EFI_DISK_READ_EX",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_DISK_READ_EX),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 6,
  .ParameterInOut_1 = IO_IN,
  ...
  .ParameterTypeName_3 = "UINT64",
  .ParameterInOut_4 = IO_IN,
  .ParameterTypeName_4 = "EFI_DISK_IO2_TOKEN*",
  .ParameterInOut_5 = IO_IN,
...
typedef struct _TYPE__EFI_DISK_IO2_TOKEN_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_DISK_IO2_TOKEN_STAR;

TYPE__EFI_DISK_IO2_TOKEN_STAR TypeInfo__EFI_DISK_IO2_TOKEN_STAR = {
  .TypeName = "EFI_DISK_IO2_TOKEN*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_DISK_IO2_TOKEN*),
  .PointedType = "EFI_DISK_IO2_TOKEN"
};


typedef struct _TYPE__EFI_DISK_IO2_TOKEN{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_2;
  const CHAR8* StructFieldTypeName_2;
} TYPE__EFI_DISK_IO2_TOKEN;

TYPE__EFI_DISK_IO2_TOKEN TypeInfo__EFI_DISK_IO2_TOKEN = {
  .TypeName = "EFI_DISK_IO2_TOKEN",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_DISK_IO2_TOKEN),
  .StructFieldNum = 2,
...
typedef struct _TYPE__EFI_DISK_WRITE_EX{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_6;
  const CHAR8* ParameterTypeName_6;
} TYPE__EFI_DISK_WRITE_EX;

TYPE__EFI_DISK_WRITE_EX TypeInfo__EFI_DISK_WRITE_EX = {
  .TypeName = "EFI_DISK_WRITE_EX",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_DISK_WRITE_EX),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 6,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_DISK_FLUSH_EX{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_DISK_FLUSH_EX;

TYPE__EFI_DISK_FLUSH_EX TypeInfo__EFI_DISK_FLUSH_EX = {
  .TypeName = "EFI_DISK_FLUSH_EX",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_DISK_FLUSH_EX),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_DISK_IO2_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "EFI_DISK_IO2_TOKEN*"
};
...
void *TypeInfoList[] = {
  &TypeInfo__gEfiDiskIoProtocolGuid,
  &TypeInfo__EFI_DISK_IO_PROTOCOL,
  &TypeInfo__UINT64,
  &TypeInfo__EFI_DISK_READ,
  &TypeInfo__EFI_STATUS,
  &TypeInfo__RETURN_STATUS,
  &TypeInfo__UINTN,
  &TypeInfo__EFI_DISK_IO_PROTOCOL_STAR,
  &TypeInfo__UINT32,
  &TypeInfo__void_STAR,
  &TypeInfo__EFI_DISK_WRITE,
  &TypeInfo__gEfiDiskIo2ProtocolGuid,
  &TypeInfo__EFI_DISK_IO2_PROTOCOL,
  &TypeInfo__EFI_DISK_CANCEL_EX,
  &TypeInfo__EFI_DISK_IO2_PROTOCOL_STAR,
  &TypeInfo__EFI_DISK_READ_EX,
  &TypeInfo__EFI_DISK_IO2_TOKEN_STAR,
  &TypeInfo__EFI_DISK_IO2_TOKEN,
  &TypeInfo__EFI_EVENT,
  &TypeInfo__EFI_DISK_WRITE_EX,
  &TypeInfo__EFI_DISK_FLUSH_EX,
  &TypeInfo__gEfiDriverBindingProtocolGuid,
