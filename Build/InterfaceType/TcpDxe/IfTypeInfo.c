...
typedef struct _TYPE__gEfiTcp6ProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiTcp6ProtocolGuid;

TYPE__gEfiTcp6ProtocolGuid TypeInfo__gEfiTcp6ProtocolGuid = {
  .TypeName = "gEfiTcp6ProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiTcp6ProtocolGuid,
  .InterfaceStructName = "EFI_TCP6_PROTOCOL"
};
...
typedef struct _TYPE__gEfiTcp4ProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiTcp4ProtocolGuid;

TYPE__gEfiTcp4ProtocolGuid TypeInfo__gEfiTcp4ProtocolGuid = {
  .TypeName = "gEfiTcp4ProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiTcp4ProtocolGuid,
  .InterfaceStructName = "EFI_TCP4_PROTOCOL"
};
...
void *TypeInfoList_OpenProtocol[] = {
  ...
  &TypeInfo__gEfiTcp6ProtocolGuid,
  &TypeInfo__gEfiTcp4ProtocolGuid,
  NULL
};
