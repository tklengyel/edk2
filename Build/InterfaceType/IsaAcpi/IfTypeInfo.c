...
typedef struct _TYPE__EFI_ISA_ACPI_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
...
} TYPE__EFI_ISA_ACPI_PROTOCOL;

TYPE__EFI_ISA_ACPI_PROTOCOL TypeInfo__EFI_ISA_ACPI_PROTOCOL = {
  .TypeName = "EFI_ISA_ACPI_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_ISA_ACPI_PROTOCOL),
  .StructFieldNum = 8,
  .StructFieldName_1 = "DeviceEnumerate",
  .StructFieldTypeName_1 = "EFI_ISA_ACPI_DEVICE_ENUMERATE",
  .StructFieldName_2 = "SetPower",
  .StructFieldTypeName_2 = "EFI_ISA_ACPI_SET_DEVICE_POWER",
  .StructFieldName_3 = "GetCurResource",
  .StructFieldTypeName_3 = "EFI_ISA_ACPI_GET_CUR_RESOURCE",
  .StructFieldName_4 = "GetPosResource",
  .StructFieldTypeName_4 = "EFI_ISA_ACPI_GET_POS_RESOURCE",
  .StructFieldName_5 = "SetResource",
  .StructFieldTypeName_5 = "EFI_ISA_ACPI_SET_RESOURCE",
  .StructFieldName_6 = "EnableDevice",
  .StructFieldTypeName_6 = "EFI_ISA_ACPI_ENABLE_DEVICE",
  .StructFieldName_7 = "InitDevice",
  .StructFieldTypeName_7 = "EFI_ISA_ACPI_INIT_DEVICE",
  .StructFieldName_8 = "InterfaceInit",
  .StructFieldTypeName_8 = "EFI_ISA_ACPI_INTERFACE_INIT"
};


typedef struct _TYPE__EFI_ISA_ACPI_DEVICE_ENUMERATE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
...
} TYPE__EFI_ISA_ACPI_DEVICE_ENUMERATE;

TYPE__EFI_ISA_ACPI_DEVICE_ENUMERATE TypeInfo__EFI_ISA_ACPI_DEVICE_ENUMERATE = {
  .TypeName = "EFI_ISA_ACPI_DEVICE_ENUMERATE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ISA_ACPI_DEVICE_ENUMERATE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_ISA_ACPI_PROTOCOL*",
  .ParameterInOut_2 = IO_OUT,
  .ParameterTypeName_2 = "EFI_ISA_ACPI_DEVICE_ID**"
};
...
typedef struct _TYPE__EFI_ISA_ACPI_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ISA_ACPI_PROTOCOL_STAR;

TYPE__EFI_ISA_ACPI_PROTOCOL_STAR TypeInfo__EFI_ISA_ACPI_PROTOCOL_STAR = {
  .TypeName = "EFI_ISA_ACPI_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_ISA_ACPI_PROTOCOL*),
  .PointedType = "EFI_ISA_ACPI_PROTOCOL"
};


typedef struct _TYPE__EFI_ISA_ACPI_DEVICE_ID_STAR_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ISA_ACPI_DEVICE_ID_STAR_STAR;

TYPE__EFI_ISA_ACPI_DEVICE_ID_STAR_STAR TypeInfo__EFI_ISA_ACPI_DEVICE_ID_STAR_STAR = {
  .TypeName = "EFI_ISA_ACPI_DEVICE_ID**",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_ISA_ACPI_DEVICE_ID**),
  .PointedType = "EFI_ISA_ACPI_DEVICE_ID*"
};


typedef struct _TYPE__EFI_ISA_ACPI_DEVICE_ID_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ISA_ACPI_DEVICE_ID_STAR;

TYPE__EFI_ISA_ACPI_DEVICE_ID_STAR TypeInfo__EFI_ISA_ACPI_DEVICE_ID_STAR = {
  .TypeName = "EFI_ISA_ACPI_DEVICE_ID*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_ISA_ACPI_DEVICE_ID*),
  .PointedType = "EFI_ISA_ACPI_DEVICE_ID"
...
typedef struct _TYPE__EFI_ISA_ACPI_SET_DEVICE_POWER{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
...
} TYPE__EFI_ISA_ACPI_SET_DEVICE_POWER;

TYPE__EFI_ISA_ACPI_SET_DEVICE_POWER TypeInfo__EFI_ISA_ACPI_SET_DEVICE_POWER = {
  .TypeName = "EFI_ISA_ACPI_SET_DEVICE_POWER",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ISA_ACPI_SET_DEVICE_POWER),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_ISA_ACPI_GET_CUR_RESOURCE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_3;
  const CHAR8* ParameterTypeName_3;
} TYPE__EFI_ISA_ACPI_GET_CUR_RESOURCE;

TYPE__EFI_ISA_ACPI_GET_CUR_RESOURCE TypeInfo__EFI_ISA_ACPI_GET_CUR_RESOURCE = {
  .TypeName = "EFI_ISA_ACPI_GET_CUR_RESOURCE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ISA_ACPI_GET_CUR_RESOURCE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
  ...
  .ParameterTypeName_3 = "EFI_ISA_ACPI_RESOURCE_LIST**"
};


typedef struct _TYPE__EFI_ISA_ACPI_RESOURCE_LIST_STAR_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ISA_ACPI_RESOURCE_LIST_STAR_STAR;

TYPE__EFI_ISA_ACPI_RESOURCE_LIST_STAR_STAR TypeInfo__EFI_ISA_ACPI_RESOURCE_LIST_STAR_STAR = {
...
typedef struct _TYPE__EFI_ISA_ACPI_GET_POS_RESOURCE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_3;
  const CHAR8* ParameterTypeName_3;
} TYPE__EFI_ISA_ACPI_GET_POS_RESOURCE;

TYPE__EFI_ISA_ACPI_GET_POS_RESOURCE TypeInfo__EFI_ISA_ACPI_GET_POS_RESOURCE = {
  .TypeName = "EFI_ISA_ACPI_GET_POS_RESOURCE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ISA_ACPI_GET_POS_RESOURCE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_ISA_ACPI_SET_RESOURCE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_3;
  const CHAR8* ParameterTypeName_3;
} TYPE__EFI_ISA_ACPI_SET_RESOURCE;

TYPE__EFI_ISA_ACPI_SET_RESOURCE TypeInfo__EFI_ISA_ACPI_SET_RESOURCE = {
  .TypeName = "EFI_ISA_ACPI_SET_RESOURCE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ISA_ACPI_SET_RESOURCE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_ISA_ACPI_ENABLE_DEVICE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_3;
  const CHAR8* ParameterTypeName_3;
} TYPE__EFI_ISA_ACPI_ENABLE_DEVICE;

TYPE__EFI_ISA_ACPI_ENABLE_DEVICE TypeInfo__EFI_ISA_ACPI_ENABLE_DEVICE = {
  .TypeName = "EFI_ISA_ACPI_ENABLE_DEVICE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ISA_ACPI_ENABLE_DEVICE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_ISA_ACPI_INIT_DEVICE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_ISA_ACPI_INIT_DEVICE;

TYPE__EFI_ISA_ACPI_INIT_DEVICE TypeInfo__EFI_ISA_ACPI_INIT_DEVICE = {
  .TypeName = "EFI_ISA_ACPI_INIT_DEVICE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ISA_ACPI_INIT_DEVICE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_ISA_ACPI_INTERFACE_INIT{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_1;
  const CHAR8* ParameterTypeName_1;
} TYPE__EFI_ISA_ACPI_INTERFACE_INIT;

TYPE__EFI_ISA_ACPI_INTERFACE_INIT TypeInfo__EFI_ISA_ACPI_INTERFACE_INIT = {
  .TypeName = "EFI_ISA_ACPI_INTERFACE_INIT",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ISA_ACPI_INTERFACE_INIT),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 1,
  .ParameterInOut_1 = IO_IN,
...
void *TypeInfoList[] = {
  &TypeInfo__gEfiIsaAcpiProtocolGuid,
  &TypeInfo__EFI_ISA_ACPI_PROTOCOL,
  &TypeInfo__EFI_ISA_ACPI_DEVICE_ENUMERATE,
  &TypeInfo__EFI_STATUS,
  &TypeInfo__RETURN_STATUS,
  &TypeInfo__UINTN,
  &TypeInfo__UINT64,
  &TypeInfo__EFI_ISA_ACPI_PROTOCOL_STAR,
  &TypeInfo__EFI_ISA_ACPI_DEVICE_ID_STAR_STAR,
  &TypeInfo__EFI_ISA_ACPI_DEVICE_ID_STAR,
  &TypeInfo__EFI_ISA_ACPI_DEVICE_ID,
  &TypeInfo__UINT32,
  &TypeInfo__EFI_ISA_ACPI_SET_DEVICE_POWER,
  &TypeInfo__BOOLEAN,
  &TypeInfo__EFI_ISA_ACPI_GET_CUR_RESOURCE,
  &TypeInfo__EFI_ISA_ACPI_RESOURCE_LIST_STAR_STAR,
  ...
  &TypeInfo__EFI_ISA_ACPI_GET_POS_RESOURCE,
  &TypeInfo__EFI_ISA_ACPI_SET_RESOURCE,
  &TypeInfo__EFI_ISA_ACPI_ENABLE_DEVICE,
  &TypeInfo__EFI_ISA_ACPI_INIT_DEVICE,
  &TypeInfo__EFI_ISA_ACPI_INTERFACE_INIT,
  &TypeInfo__gEfiDriverBindingProtocolGuid,
