...
typedef struct _TYPE__gEfiMtftp4ServiceBindingProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiMtftp4ServiceBindingProtocolGuid;

TYPE__gEfiMtftp4ServiceBindingProtocolGuid TypeInfo__gEfiMtftp4ServiceBindingProtocolGuid = {
  .TypeName = "gEfiMtftp4ServiceBindingProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiMtftp4ServiceBindingProtocolGuid,
...
typedef struct _TYPE__EFI_MTFTP4_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
...
} TYPE__EFI_MTFTP4_PROTOCOL;

TYPE__EFI_MTFTP4_PROTOCOL TypeInfo__EFI_MTFTP4_PROTOCOL = {
  .TypeName = "EFI_MTFTP4_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_PROTOCOL),
  .StructFieldNum = 8,
  .StructFieldName_1 = "GetModeData",
  .StructFieldTypeName_1 = "EFI_MTFTP4_GET_MODE_DATA",
  .StructFieldName_2 = "Configure",
  .StructFieldTypeName_2 = "EFI_MTFTP4_CONFIGURE",
  .StructFieldName_3 = "GetInfo",
  .StructFieldTypeName_3 = "EFI_MTFTP4_GET_INFO",
  .StructFieldName_4 = "ParseOptions",
  .StructFieldTypeName_4 = "EFI_MTFTP4_PARSE_OPTIONS",
  .StructFieldName_5 = "ReadFile",
  .StructFieldTypeName_5 = "EFI_MTFTP4_READ_FILE",
  .StructFieldName_6 = "WriteFile",
  .StructFieldTypeName_6 = "EFI_MTFTP4_WRITE_FILE",
  .StructFieldName_7 = "ReadDirectory",
  .StructFieldTypeName_7 = "EFI_MTFTP4_READ_DIRECTORY",
  .StructFieldName_8 = "Poll",
  .StructFieldTypeName_8 = "EFI_MTFTP4_POLL"
};


typedef struct _TYPE__EFI_MTFTP4_GET_MODE_DATA{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_MTFTP4_GET_MODE_DATA;

TYPE__EFI_MTFTP4_GET_MODE_DATA TypeInfo__EFI_MTFTP4_GET_MODE_DATA = {
  .TypeName = "EFI_MTFTP4_GET_MODE_DATA",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_GET_MODE_DATA),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_MTFTP4_PROTOCOL*",
  .ParameterInOut_2 = IO_OUT,
  .ParameterTypeName_2 = "EFI_MTFTP4_MODE_DATA*"
};


typedef struct _TYPE__EFI_MTFTP4_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_MTFTP4_PROTOCOL_STAR;

TYPE__EFI_MTFTP4_PROTOCOL_STAR TypeInfo__EFI_MTFTP4_PROTOCOL_STAR = {
  .TypeName = "EFI_MTFTP4_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_MTFTP4_PROTOCOL*),
  .PointedType = "EFI_MTFTP4_PROTOCOL"
};


typedef struct _TYPE__EFI_MTFTP4_MODE_DATA_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_MTFTP4_MODE_DATA_STAR;

TYPE__EFI_MTFTP4_MODE_DATA_STAR TypeInfo__EFI_MTFTP4_MODE_DATA_STAR = {
  .TypeName = "EFI_MTFTP4_MODE_DATA*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_MTFTP4_MODE_DATA*),
  .PointedType = "EFI_MTFTP4_MODE_DATA"
};


typedef struct _TYPE__EFI_MTFTP4_MODE_DATA{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_5;
  const CHAR8* StructFieldTypeName_5;
} TYPE__EFI_MTFTP4_MODE_DATA;

TYPE__EFI_MTFTP4_MODE_DATA TypeInfo__EFI_MTFTP4_MODE_DATA = {
  .TypeName = "EFI_MTFTP4_MODE_DATA",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_MODE_DATA),
  .StructFieldNum = 5,
  .StructFieldName_1 = "ConfigData",
  .StructFieldTypeName_1 = "EFI_MTFTP4_CONFIG_DATA",
  .StructFieldName_2 = "SupportedOptionCount",
  .StructFieldTypeName_2 = "UINT8",
  .StructFieldName_3 = "SupportedOptoins",
  .StructFieldTypeName_3 = "UINT8**",
  .StructFieldName_4 = "UnsupportedOptionCount",
  .StructFieldTypeName_4 = "UINT8",
  .StructFieldName_5 = "UnsupportedOptoins",
  .StructFieldTypeName_5 = "UINT8**"
};


typedef struct _TYPE__EFI_MTFTP4_CONFIG_DATA{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
...
} TYPE__EFI_MTFTP4_CONFIG_DATA;

TYPE__EFI_MTFTP4_CONFIG_DATA TypeInfo__EFI_MTFTP4_CONFIG_DATA = {
  .TypeName = "EFI_MTFTP4_CONFIG_DATA",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_CONFIG_DATA),
  .StructFieldNum = 9,
  .StructFieldName_1 = "UseDefaultSetting",
  .StructFieldTypeName_1 = "BOOLEAN",
  .StructFieldName_2 = "StationIp",
  .StructFieldTypeName_2 = "EFI_IPv4_ADDRESS",
  .StructFieldName_3 = "SubnetMask",
  .StructFieldTypeName_3 = "EFI_IPv4_ADDRESS",
  .StructFieldName_4 = "LocalPort",
  .StructFieldTypeName_4 = "UINT16",
  .StructFieldName_5 = "GatewayIp",
  .StructFieldTypeName_5 = "EFI_IPv4_ADDRESS",
  .StructFieldName_6 = "ServerIp",
  .StructFieldTypeName_6 = "EFI_IPv4_ADDRESS",
  .StructFieldName_7 = "InitialServerPort",
  .StructFieldTypeName_7 = "UINT16",
  .StructFieldName_8 = "TryCount",
  .StructFieldTypeName_8 = "UINT16",
  .StructFieldName_9 = "TimeoutValue",
...
typedef struct _TYPE__EFI_MTFTP4_CONFIGURE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_MTFTP4_CONFIGURE;

TYPE__EFI_MTFTP4_CONFIGURE TypeInfo__EFI_MTFTP4_CONFIGURE = {
  .TypeName = "EFI_MTFTP4_CONFIGURE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_CONFIGURE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_MTFTP4_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "EFI_MTFTP4_CONFIG_DATA*"
};


typedef struct _TYPE__EFI_MTFTP4_CONFIG_DATA_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_MTFTP4_CONFIG_DATA_STAR;

TYPE__EFI_MTFTP4_CONFIG_DATA_STAR TypeInfo__EFI_MTFTP4_CONFIG_DATA_STAR = {
  .TypeName = "EFI_MTFTP4_CONFIG_DATA*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_MTFTP4_CONFIG_DATA*),
  .PointedType = "EFI_MTFTP4_CONFIG_DATA"
};


typedef struct _TYPE__EFI_MTFTP4_GET_INFO{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
...
} TYPE__EFI_MTFTP4_GET_INFO;

TYPE__EFI_MTFTP4_GET_INFO TypeInfo__EFI_MTFTP4_GET_INFO = {
  .TypeName = "EFI_MTFTP4_GET_INFO",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_GET_INFO),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 8,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_MTFTP4_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "EFI_MTFTP4_OVERRIDE_DATA*",
  ...
  .ParameterTypeName_6 = "EFI_MTFTP4_OPTION*",
  .ParameterInOut_7 = IO_OUT,
  .ParameterTypeName_7 = "UINT32*",
  .ParameterInOut_8 = IO_OUT,
  .ParameterTypeName_8 = "EFI_MTFTP4_PACKET**"
};


typedef struct _TYPE__EFI_MTFTP4_OVERRIDE_DATA_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_MTFTP4_OVERRIDE_DATA_STAR;

TYPE__EFI_MTFTP4_OVERRIDE_DATA_STAR TypeInfo__EFI_MTFTP4_OVERRIDE_DATA_STAR = {
  .TypeName = "EFI_MTFTP4_OVERRIDE_DATA*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_MTFTP4_OVERRIDE_DATA*),
  .PointedType = "EFI_MTFTP4_OVERRIDE_DATA"
};


typedef struct _TYPE__EFI_MTFTP4_OVERRIDE_DATA{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_5;
  const CHAR8* StructFieldTypeName_5;
} TYPE__EFI_MTFTP4_OVERRIDE_DATA;

TYPE__EFI_MTFTP4_OVERRIDE_DATA TypeInfo__EFI_MTFTP4_OVERRIDE_DATA = {
  .TypeName = "EFI_MTFTP4_OVERRIDE_DATA",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_OVERRIDE_DATA),
  .StructFieldNum = 5,
  .StructFieldName_1 = "GatewayIp",
  .StructFieldTypeName_1 = "EFI_IPv4_ADDRESS",
  .StructFieldName_2 = "ServerIp",
  .StructFieldTypeName_2 = "EFI_IPv4_ADDRESS",
  .StructFieldName_3 = "ServerPort",
  .StructFieldTypeName_3 = "UINT16",
  .StructFieldName_4 = "TryCount",
  .StructFieldTypeName_4 = "UINT16",
  .StructFieldName_5 = "TimeoutValue",
  .StructFieldTypeName_5 = "UINT16"
};


typedef struct _TYPE__EFI_MTFTP4_OPTION_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_MTFTP4_OPTION_STAR;

TYPE__EFI_MTFTP4_OPTION_STAR TypeInfo__EFI_MTFTP4_OPTION_STAR = {
  .TypeName = "EFI_MTFTP4_OPTION*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_MTFTP4_OPTION*),
  .PointedType = "EFI_MTFTP4_OPTION"
};


typedef struct _TYPE__EFI_MTFTP4_OPTION{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_2;
  const CHAR8* StructFieldTypeName_2;
} TYPE__EFI_MTFTP4_OPTION;

TYPE__EFI_MTFTP4_OPTION TypeInfo__EFI_MTFTP4_OPTION = {
  .TypeName = "EFI_MTFTP4_OPTION",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_OPTION),
  .StructFieldNum = 2,
...
typedef struct _TYPE__EFI_MTFTP4_PACKET_STAR_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_MTFTP4_PACKET_STAR_STAR;

TYPE__EFI_MTFTP4_PACKET_STAR_STAR TypeInfo__EFI_MTFTP4_PACKET_STAR_STAR = {
  .TypeName = "EFI_MTFTP4_PACKET**",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_MTFTP4_PACKET**),
  .PointedType = "EFI_MTFTP4_PACKET*"
};


typedef struct _TYPE__EFI_MTFTP4_PACKET_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_MTFTP4_PACKET_STAR;

TYPE__EFI_MTFTP4_PACKET_STAR TypeInfo__EFI_MTFTP4_PACKET_STAR = {
  .TypeName = "EFI_MTFTP4_PACKET*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_MTFTP4_PACKET*),
  .PointedType = "EFI_MTFTP4_PACKET"
...
typedef struct _TYPE__EFI_MTFTP4_PACKET{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_9;
  const CHAR8* StructFieldTypeName_9;
} TYPE__EFI_MTFTP4_PACKET;

TYPE__EFI_MTFTP4_PACKET TypeInfo__EFI_MTFTP4_PACKET = {
  .TypeName = "EFI_MTFTP4_PACKET",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_PACKET),
  .StructFieldNum = 9,
  ...
  .StructFieldTypeName_2 = "EFI_MTFTP4_REQ_HEADER",
  .StructFieldName_3 = "Wrq",
  .StructFieldTypeName_3 = "EFI_MTFTP4_REQ_HEADER",
  .StructFieldName_4 = "Oack",
  .StructFieldTypeName_4 = "EFI_MTFTP4_OACK_HEADER",
  .StructFieldName_5 = "Data",
  .StructFieldTypeName_5 = "EFI_MTFTP4_DATA_HEADER",
  .StructFieldName_6 = "Ack",
  .StructFieldTypeName_6 = "EFI_MTFTP4_ACK_HEADER",
  .StructFieldName_7 = "Data8",
  .StructFieldTypeName_7 = "EFI_MTFTP4_DATA8_HEADER",
  .StructFieldName_8 = "Ack8",
  .StructFieldTypeName_8 = "EFI_MTFTP4_ACK8_HEADER",
  .StructFieldName_9 = "Error",
  .StructFieldTypeName_9 = "EFI_MTFTP4_ERROR_HEADER"
};


typedef struct _TYPE__EFI_MTFTP4_REQ_HEADER{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_2;
  const CHAR8* StructFieldTypeName_2;
} TYPE__EFI_MTFTP4_REQ_HEADER;

TYPE__EFI_MTFTP4_REQ_HEADER TypeInfo__EFI_MTFTP4_REQ_HEADER = {
  .TypeName = "EFI_MTFTP4_REQ_HEADER",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_REQ_HEADER),
  .StructFieldNum = 2,
  .StructFieldName_1 = "OpCode",
  .StructFieldTypeName_1 = "UINT16",
...
typedef struct _TYPE__EFI_MTFTP4_OACK_HEADER{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_2;
  const CHAR8* StructFieldTypeName_2;
} TYPE__EFI_MTFTP4_OACK_HEADER;

TYPE__EFI_MTFTP4_OACK_HEADER TypeInfo__EFI_MTFTP4_OACK_HEADER = {
  .TypeName = "EFI_MTFTP4_OACK_HEADER",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_OACK_HEADER),
  .StructFieldNum = 2,
  .StructFieldName_1 = "OpCode",
  .StructFieldTypeName_1 = "UINT16",
...
typedef struct _TYPE__EFI_MTFTP4_DATA_HEADER{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_3;
  const CHAR8* StructFieldTypeName_3;
} TYPE__EFI_MTFTP4_DATA_HEADER;

TYPE__EFI_MTFTP4_DATA_HEADER TypeInfo__EFI_MTFTP4_DATA_HEADER = {
  .TypeName = "EFI_MTFTP4_DATA_HEADER",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_DATA_HEADER),
  .StructFieldNum = 3,
  .StructFieldName_1 = "OpCode",
  .StructFieldTypeName_1 = "UINT16",
...
typedef struct _TYPE__EFI_MTFTP4_ACK_HEADER{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_2;
  const CHAR8* StructFieldTypeName_2;
} TYPE__EFI_MTFTP4_ACK_HEADER;

TYPE__EFI_MTFTP4_ACK_HEADER TypeInfo__EFI_MTFTP4_ACK_HEADER = {
  .TypeName = "EFI_MTFTP4_ACK_HEADER",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_ACK_HEADER),
  .StructFieldNum = 2,
  .StructFieldName_1 = "OpCode",
  .StructFieldTypeName_1 = "UINT16",
  .StructFieldName_2 = "Block",
...
typedef struct _TYPE__EFI_MTFTP4_DATA8_HEADER{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_3;
  const CHAR8* StructFieldTypeName_3;
} TYPE__EFI_MTFTP4_DATA8_HEADER;

TYPE__EFI_MTFTP4_DATA8_HEADER TypeInfo__EFI_MTFTP4_DATA8_HEADER = {
  .TypeName = "EFI_MTFTP4_DATA8_HEADER",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_DATA8_HEADER),
  .StructFieldNum = 3,
  .StructFieldName_1 = "OpCode",
  .StructFieldTypeName_1 = "UINT16",
  .StructFieldName_2 = "Block",
...
typedef struct _TYPE__EFI_MTFTP4_ACK8_HEADER{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_2;
  const CHAR8* StructFieldTypeName_2;
} TYPE__EFI_MTFTP4_ACK8_HEADER;

TYPE__EFI_MTFTP4_ACK8_HEADER TypeInfo__EFI_MTFTP4_ACK8_HEADER = {
  .TypeName = "EFI_MTFTP4_ACK8_HEADER",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_ACK8_HEADER),
  .StructFieldNum = 2,
  .StructFieldName_1 = "OpCode",
  .StructFieldTypeName_1 = "UINT16",
  .StructFieldName_2 = "Block",
...
typedef struct _TYPE__EFI_MTFTP4_ERROR_HEADER{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_3;
  const CHAR8* StructFieldTypeName_3;
} TYPE__EFI_MTFTP4_ERROR_HEADER;

TYPE__EFI_MTFTP4_ERROR_HEADER TypeInfo__EFI_MTFTP4_ERROR_HEADER = {
  .TypeName = "EFI_MTFTP4_ERROR_HEADER",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_ERROR_HEADER),
  .StructFieldNum = 3,
  .StructFieldName_1 = "OpCode",
  .StructFieldTypeName_1 = "UINT16",
...
typedef struct _TYPE__EFI_MTFTP4_PARSE_OPTIONS{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_5;
  const CHAR8* ParameterTypeName_5;
} TYPE__EFI_MTFTP4_PARSE_OPTIONS;

TYPE__EFI_MTFTP4_PARSE_OPTIONS TypeInfo__EFI_MTFTP4_PARSE_OPTIONS = {
  .TypeName = "EFI_MTFTP4_PARSE_OPTIONS",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_PARSE_OPTIONS),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 5,
  .ParameterInOut_1 = IO_IN,
  ...
  .ParameterInOut_3 = IO_IN,
  .ParameterTypeName_3 = "EFI_MTFTP4_PACKET*",
  .ParameterInOut_4 = IO_OUT,
  .ParameterTypeName_4 = "UINT32*",
  .ParameterInOut_5 = IO_OUT,
  .ParameterTypeName_5 = "EFI_MTFTP4_OPTION**"
};


typedef struct _TYPE__EFI_MTFTP4_OPTION_STAR_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_MTFTP4_OPTION_STAR_STAR;

TYPE__EFI_MTFTP4_OPTION_STAR_STAR TypeInfo__EFI_MTFTP4_OPTION_STAR_STAR = {
  .TypeName = "EFI_MTFTP4_OPTION**",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_MTFTP4_OPTION**),
  .PointedType = "EFI_MTFTP4_OPTION*"
...
typedef struct _TYPE__EFI_MTFTP4_READ_FILE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_MTFTP4_READ_FILE;

TYPE__EFI_MTFTP4_READ_FILE TypeInfo__EFI_MTFTP4_READ_FILE = {
  .TypeName = "EFI_MTFTP4_READ_FILE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_READ_FILE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_MTFTP4_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "EFI_MTFTP4_TOKEN*"
};


typedef struct _TYPE__EFI_MTFTP4_TOKEN_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_MTFTP4_TOKEN_STAR;

TYPE__EFI_MTFTP4_TOKEN_STAR TypeInfo__EFI_MTFTP4_TOKEN_STAR = {
  .TypeName = "EFI_MTFTP4_TOKEN*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_MTFTP4_TOKEN*),
  .PointedType = "EFI_MTFTP4_TOKEN"
};


typedef struct _TYPE__EFI_MTFTP4_TOKEN{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
...
} TYPE__EFI_MTFTP4_TOKEN;

TYPE__EFI_MTFTP4_TOKEN TypeInfo__EFI_MTFTP4_TOKEN = {
  .TypeName = "EFI_MTFTP4_TOKEN",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_MTFTP4_TOKEN),
  .StructFieldNum = 13,
  ...
  .StructFieldTypeName_3 = "EFI_MTFTP4_OVERRIDE_DATA*",
  ...
  .StructFieldTypeName_7 = "EFI_MTFTP4_OPTION*",
  ...
  .StructFieldTypeName_11 = "EFI_MTFTP4_CHECK_PACKET",
  .StructFieldName_12 = "TimeoutCallback",
  .StructFieldTypeName_12 = "EFI_MTFTP4_TIMEOUT_CALLBACK",
  .StructFieldName_13 = "PacketNeeded",
  .StructFieldTypeName_13 = "EFI_MTFTP4_PACKET_NEEDED"
};
...
typedef struct _TYPE__EFI_MTFTP4_CHECK_PACKET{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_4;
  const CHAR8* ParameterTypeName_4;
} TYPE__EFI_MTFTP4_CHECK_PACKET;

TYPE__EFI_MTFTP4_CHECK_PACKET TypeInfo__EFI_MTFTP4_CHECK_PACKET = {
  .TypeName = "EFI_MTFTP4_CHECK_PACKET",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_CHECK_PACKET),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 4,
  .ParameterInOut_1 = IO_IN,
  ...
  .ParameterInOut_4 = IO_IN,
  .ParameterTypeName_4 = "EFI_MTFTP4_PACKET*"
};


typedef struct _TYPE__EFI_MTFTP4_TIMEOUT_CALLBACK{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_MTFTP4_TIMEOUT_CALLBACK;

TYPE__EFI_MTFTP4_TIMEOUT_CALLBACK TypeInfo__EFI_MTFTP4_TIMEOUT_CALLBACK = {
  .TypeName = "EFI_MTFTP4_TIMEOUT_CALLBACK",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_TIMEOUT_CALLBACK),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_MTFTP4_PACKET_NEEDED{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_4;
  const CHAR8* ParameterTypeName_4;
} TYPE__EFI_MTFTP4_PACKET_NEEDED;

TYPE__EFI_MTFTP4_PACKET_NEEDED TypeInfo__EFI_MTFTP4_PACKET_NEEDED = {
  .TypeName = "EFI_MTFTP4_PACKET_NEEDED",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_PACKET_NEEDED),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 4,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_MTFTP4_WRITE_FILE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_MTFTP4_WRITE_FILE;

TYPE__EFI_MTFTP4_WRITE_FILE TypeInfo__EFI_MTFTP4_WRITE_FILE = {
  .TypeName = "EFI_MTFTP4_WRITE_FILE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_WRITE_FILE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_MTFTP4_READ_DIRECTORY{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_MTFTP4_READ_DIRECTORY;

TYPE__EFI_MTFTP4_READ_DIRECTORY TypeInfo__EFI_MTFTP4_READ_DIRECTORY = {
  .TypeName = "EFI_MTFTP4_READ_DIRECTORY",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_READ_DIRECTORY),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_MTFTP4_POLL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_1;
  const CHAR8* ParameterTypeName_1;
} TYPE__EFI_MTFTP4_POLL;

TYPE__EFI_MTFTP4_POLL TypeInfo__EFI_MTFTP4_POLL = {
  .TypeName = "EFI_MTFTP4_POLL",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_MTFTP4_POLL),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 1,
  .ParameterInOut_1 = IO_IN,
...
void *TypeInfoList_OpenProtocol[] = {
  ...
  &TypeInfo__gEfiMtftp4ServiceBindingProtocolGuid,
...
void *TypeInfoList[] = {
  ...
  &TypeInfo__EFI_MTFTP4_PROTOCOL,
  &TypeInfo__EFI_MTFTP4_GET_MODE_DATA,
  &TypeInfo__EFI_MTFTP4_PROTOCOL_STAR,
  &TypeInfo__EFI_MTFTP4_MODE_DATA_STAR,
  &TypeInfo__EFI_MTFTP4_MODE_DATA,
  &TypeInfo__EFI_MTFTP4_CONFIG_DATA,
  &TypeInfo__BOOLEAN,
  ...
  &TypeInfo__EFI_MTFTP4_CONFIGURE,
  &TypeInfo__EFI_MTFTP4_CONFIG_DATA_STAR,
  &TypeInfo__EFI_MTFTP4_GET_INFO,
  &TypeInfo__EFI_MTFTP4_OVERRIDE_DATA_STAR,
  &TypeInfo__EFI_MTFTP4_OVERRIDE_DATA,
  &TypeInfo__EFI_MTFTP4_OPTION_STAR,
  &TypeInfo__EFI_MTFTP4_OPTION,
  &TypeInfo__UINT32_STAR,
  &TypeInfo__UINT32,
  &TypeInfo__EFI_MTFTP4_PACKET_STAR_STAR,
  &TypeInfo__EFI_MTFTP4_PACKET_STAR,
  &TypeInfo__EFI_MTFTP4_PACKET,
  &TypeInfo__EFI_MTFTP4_REQ_HEADER,
  &TypeInfo__UINT8_ARRAY_1,
  &TypeInfo__EFI_MTFTP4_OACK_HEADER,
  &TypeInfo__EFI_MTFTP4_DATA_HEADER,
  &TypeInfo__EFI_MTFTP4_ACK_HEADER,
  &TypeInfo__UINT16_ARRAY_1,
  &TypeInfo__EFI_MTFTP4_DATA8_HEADER,
  &TypeInfo__EFI_MTFTP4_ACK8_HEADER,
  &TypeInfo__UINT64_ARRAY_1,
  &TypeInfo__EFI_MTFTP4_ERROR_HEADER,
  &TypeInfo__EFI_MTFTP4_PARSE_OPTIONS,
  &TypeInfo__EFI_MTFTP4_OPTION_STAR_STAR,
  &TypeInfo__EFI_MTFTP4_READ_FILE,
  &TypeInfo__EFI_MTFTP4_TOKEN_STAR,
  &TypeInfo__EFI_MTFTP4_TOKEN,
  &TypeInfo__EFI_EVENT,
  &TypeInfo__EFI_MTFTP4_CHECK_PACKET,
  &TypeInfo__EFI_MTFTP4_TIMEOUT_CALLBACK,
  &TypeInfo__EFI_MTFTP4_PACKET_NEEDED,
  &TypeInfo__UINT16_STAR,
  &TypeInfo__void_STAR_STAR,
  &TypeInfo__EFI_MTFTP4_WRITE_FILE,
  &TypeInfo__EFI_MTFTP4_READ_DIRECTORY,
  &TypeInfo__EFI_MTFTP4_POLL,
  &TypeInfo__gEfiDriverBindingProtocolGuid,
