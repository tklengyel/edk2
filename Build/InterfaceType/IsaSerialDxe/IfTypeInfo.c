...
typedef struct _TYPE__EFI_SERIAL_IO_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
...
} TYPE__EFI_SERIAL_IO_PROTOCOL;

TYPE__EFI_SERIAL_IO_PROTOCOL TypeInfo__EFI_SERIAL_IO_PROTOCOL = {
  .TypeName = "EFI_SERIAL_IO_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_SERIAL_IO_PROTOCOL),
  .StructFieldNum = 8,
  .StructFieldName_1 = "Revision",
  .StructFieldTypeName_1 = "UINT32",
  .StructFieldName_2 = "Reset",
  .StructFieldTypeName_2 = "EFI_SERIAL_RESET",
  .StructFieldName_3 = "SetAttributes",
  .StructFieldTypeName_3 = "EFI_SERIAL_SET_ATTRIBUTES",
  .StructFieldName_4 = "SetControl",
  .StructFieldTypeName_4 = "EFI_SERIAL_SET_CONTROL_BITS",
  .StructFieldName_5 = "GetControl",
  .StructFieldTypeName_5 = "EFI_SERIAL_GET_CONTROL_BITS",
  .StructFieldName_6 = "Write",
  .StructFieldTypeName_6 = "EFI_SERIAL_WRITE",
  .StructFieldName_7 = "Read",
  .StructFieldTypeName_7 = "EFI_SERIAL_READ",
  .StructFieldName_8 = "Mode",
  .StructFieldTypeName_8 = "EFI_SERIAL_IO_MODE*"
};
...
typedef struct _TYPE__EFI_SERIAL_RESET{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
...
} TYPE__EFI_SERIAL_RESET;

TYPE__EFI_SERIAL_RESET TypeInfo__EFI_SERIAL_RESET = {
  .TypeName = "EFI_SERIAL_RESET",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_SERIAL_RESET),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 1,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_SERIAL_IO_PROTOCOL*"
};
...
typedef struct _TYPE__EFI_SERIAL_IO_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_SERIAL_IO_PROTOCOL_STAR;

TYPE__EFI_SERIAL_IO_PROTOCOL_STAR TypeInfo__EFI_SERIAL_IO_PROTOCOL_STAR = {
  .TypeName = "EFI_SERIAL_IO_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_SERIAL_IO_PROTOCOL*),
  .PointedType = "EFI_SERIAL_IO_PROTOCOL"
};


typedef struct _TYPE__EFI_SERIAL_SET_ATTRIBUTES{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
...
} TYPE__EFI_SERIAL_SET_ATTRIBUTES;

TYPE__EFI_SERIAL_SET_ATTRIBUTES TypeInfo__EFI_SERIAL_SET_ATTRIBUTES = {
  .TypeName = "EFI_SERIAL_SET_ATTRIBUTES",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_SERIAL_SET_ATTRIBUTES),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 7,
  .ParameterInOut_1 = IO_IN,
  ...
  .ParameterTypeName_5 = "EFI_PARITY_TYPE",
  .ParameterInOut_6 = IO_IN,
  .ParameterTypeName_6 = "UINT8",
  .ParameterInOut_7 = IO_IN,
  .ParameterTypeName_7 = "EFI_STOP_BITS_TYPE"
};


typedef struct _TYPE__EFI_PARITY_TYPE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
...
} TYPE__EFI_PARITY_TYPE;

TYPE__EFI_PARITY_TYPE TypeInfo__EFI_PARITY_TYPE = {
  .TypeName = "EFI_PARITY_TYPE",
  .TypeClass = TYPE_CLASS_ENUM,
  .TypeSize = sizeof(EFI_PARITY_TYPE),
  .EnumValueNum = 6,
  .EnumValueName_1 = "DefaultParity",
  .EnumValue_1 = DefaultParity,
  .EnumValueName_2 = "NoParity",
  .EnumValue_2 = NoParity,
  .EnumValueName_3 = "EvenParity",
  .EnumValue_3 = EvenParity,
  .EnumValueName_4 = "OddParity",
  .EnumValue_4 = OddParity,
  .EnumValueName_5 = "MarkParity",
  .EnumValue_5 = MarkParity,
  .EnumValueName_6 = "SpaceParity",
  .EnumValue_6 = SpaceParity
};


typedef struct _TYPE__EFI_STOP_BITS_TYPE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN EnumValueNum;
  ...
  const CHAR8* EnumValueName_4;
  const UINTN EnumValue_4;
} TYPE__EFI_STOP_BITS_TYPE;

TYPE__EFI_STOP_BITS_TYPE TypeInfo__EFI_STOP_BITS_TYPE = {
  .TypeName = "EFI_STOP_BITS_TYPE",
  .TypeClass = TYPE_CLASS_ENUM,
  .TypeSize = sizeof(EFI_STOP_BITS_TYPE),
  .EnumValueNum = 4,
  .EnumValueName_1 = "DefaultStopBits",
  .EnumValue_1 = DefaultStopBits,
  .EnumValueName_2 = "OneStopBit",
  .EnumValue_2 = OneStopBit,
  .EnumValueName_3 = "OneFiveStopBits",
  .EnumValue_3 = OneFiveStopBits,
  .EnumValueName_4 = "TwoStopBits",
  .EnumValue_4 = TwoStopBits
};


typedef struct _TYPE__EFI_SERIAL_SET_CONTROL_BITS{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_SERIAL_SET_CONTROL_BITS;

TYPE__EFI_SERIAL_SET_CONTROL_BITS TypeInfo__EFI_SERIAL_SET_CONTROL_BITS = {
  .TypeName = "EFI_SERIAL_SET_CONTROL_BITS",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_SERIAL_SET_CONTROL_BITS),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_SERIAL_GET_CONTROL_BITS{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_SERIAL_GET_CONTROL_BITS;

TYPE__EFI_SERIAL_GET_CONTROL_BITS TypeInfo__EFI_SERIAL_GET_CONTROL_BITS = {
  .TypeName = "EFI_SERIAL_GET_CONTROL_BITS",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_SERIAL_GET_CONTROL_BITS),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_SERIAL_WRITE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_3;
  const CHAR8* ParameterTypeName_3;
} TYPE__EFI_SERIAL_WRITE;

TYPE__EFI_SERIAL_WRITE TypeInfo__EFI_SERIAL_WRITE = {
  .TypeName = "EFI_SERIAL_WRITE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_SERIAL_WRITE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_SERIAL_READ{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_3;
  const CHAR8* ParameterTypeName_3;
} TYPE__EFI_SERIAL_READ;

TYPE__EFI_SERIAL_READ TypeInfo__EFI_SERIAL_READ = {
  .TypeName = "EFI_SERIAL_READ",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_SERIAL_READ),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_SERIAL_IO_MODE_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_SERIAL_IO_MODE_STAR;

TYPE__EFI_SERIAL_IO_MODE_STAR TypeInfo__EFI_SERIAL_IO_MODE_STAR = {
  .TypeName = "EFI_SERIAL_IO_MODE*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_SERIAL_IO_MODE*),
  .PointedType = "EFI_SERIAL_IO_MODE"
};


typedef struct _TYPE__EFI_SERIAL_IO_MODE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_7;
  const CHAR8* StructFieldTypeName_7;
} TYPE__EFI_SERIAL_IO_MODE;

TYPE__EFI_SERIAL_IO_MODE TypeInfo__EFI_SERIAL_IO_MODE = {
  .TypeName = "EFI_SERIAL_IO_MODE",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_SERIAL_IO_MODE),
  .StructFieldNum = 7,
  .StructFieldName_1 = "ControlMask",
  .StructFieldTypeName_1 = "UINT32",
  .StructFieldName_2 = "Timeout",
  .StructFieldTypeName_2 = "UINT32",
  .StructFieldName_3 = "BaudRate",
  .StructFieldTypeName_3 = "UINT64",
  .StructFieldName_4 = "ReceiveFifoDepth",
  .StructFieldTypeName_4 = "UINT32",
  .StructFieldName_5 = "DataBits",
  .StructFieldTypeName_5 = "UINT32",
  .StructFieldName_6 = "Parity",
  .StructFieldTypeName_6 = "UINT32",
  .StructFieldName_7 = "StopBits",
...
void *TypeInfoList[] = {
  ...
  &TypeInfo__EFI_SERIAL_IO_PROTOCOL,
  &TypeInfo__UINT32,
  &TypeInfo__EFI_SERIAL_RESET,
  &TypeInfo__EFI_STATUS,
  &TypeInfo__RETURN_STATUS,
  &TypeInfo__UINTN,
  &TypeInfo__UINT64,
  &TypeInfo__EFI_SERIAL_IO_PROTOCOL_STAR,
  &TypeInfo__EFI_SERIAL_SET_ATTRIBUTES,
  &TypeInfo__EFI_PARITY_TYPE,
  &TypeInfo__EFI_STOP_BITS_TYPE,
  &TypeInfo__EFI_SERIAL_SET_CONTROL_BITS,
  &TypeInfo__EFI_SERIAL_GET_CONTROL_BITS,
  &TypeInfo__UINT32_STAR,
  &TypeInfo__EFI_SERIAL_WRITE,
  &TypeInfo__UINTN_STAR,
  &TypeInfo__void_STAR,
  &TypeInfo__EFI_SERIAL_READ,
  &TypeInfo__EFI_SERIAL_IO_MODE_STAR,
  &TypeInfo__EFI_SERIAL_IO_MODE,
  &TypeInfo__gEfiDriverBindingProtocolGuid,
