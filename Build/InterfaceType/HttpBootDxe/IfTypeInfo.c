...
typedef struct _TYPE__EFI_HTTP_BOOT_CALLBACK_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  const CHAR8* StructFieldName_1;
  const CHAR8* StructFieldTypeName_1;
} TYPE__EFI_HTTP_BOOT_CALLBACK_PROTOCOL;

TYPE__EFI_HTTP_BOOT_CALLBACK_PROTOCOL TypeInfo__EFI_HTTP_BOOT_CALLBACK_PROTOCOL = {
  .TypeName = "EFI_HTTP_BOOT_CALLBACK_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_HTTP_BOOT_CALLBACK_PROTOCOL),
  .StructFieldNum = 1,
  .StructFieldName_1 = "Callback",
  .StructFieldTypeName_1 = "EFI_HTTP_BOOT_CALLBACK"
};


typedef struct _TYPE__EFI_HTTP_BOOT_CALLBACK{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_5;
  const CHAR8* ParameterTypeName_5;
} TYPE__EFI_HTTP_BOOT_CALLBACK;

TYPE__EFI_HTTP_BOOT_CALLBACK TypeInfo__EFI_HTTP_BOOT_CALLBACK = {
  .TypeName = "EFI_HTTP_BOOT_CALLBACK",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_HTTP_BOOT_CALLBACK),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 5,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_HTTP_BOOT_CALLBACK_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "EFI_HTTP_BOOT_CALLBACK_DATA_TYPE",
  .ParameterInOut_3 = IO_IN,
...
typedef struct _TYPE__EFI_HTTP_BOOT_CALLBACK_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_HTTP_BOOT_CALLBACK_PROTOCOL_STAR;

TYPE__EFI_HTTP_BOOT_CALLBACK_PROTOCOL_STAR TypeInfo__EFI_HTTP_BOOT_CALLBACK_PROTOCOL_STAR = {
  .TypeName = "EFI_HTTP_BOOT_CALLBACK_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_HTTP_BOOT_CALLBACK_PROTOCOL*),
  .PointedType = "EFI_HTTP_BOOT_CALLBACK_PROTOCOL"
};


typedef struct _TYPE__EFI_HTTP_BOOT_CALLBACK_DATA_TYPE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
...
} TYPE__EFI_HTTP_BOOT_CALLBACK_DATA_TYPE;

TYPE__EFI_HTTP_BOOT_CALLBACK_DATA_TYPE TypeInfo__EFI_HTTP_BOOT_CALLBACK_DATA_TYPE = {
  .TypeName = "EFI_HTTP_BOOT_CALLBACK_DATA_TYPE",
  .TypeClass = TYPE_CLASS_ENUM,
  .TypeSize = sizeof(EFI_HTTP_BOOT_CALLBACK_DATA_TYPE),
  .EnumValueNum = 6,
  .EnumValueName_1 = "HttpBootDhcp4",
  .EnumValue_1 = HttpBootDhcp4,
  .EnumValueName_2 = "HttpBootDhcp6",
  .EnumValue_2 = HttpBootDhcp6,
  .EnumValueName_3 = "HttpBootHttpRequest",
  .EnumValue_3 = HttpBootHttpRequest,
  .EnumValueName_4 = "HttpBootHttpResponse",
  .EnumValue_4 = HttpBootHttpResponse,
  .EnumValueName_5 = "HttpBootHttpEntityBody",
  .EnumValue_5 = HttpBootHttpEntityBody,
  .EnumValueName_6 = "HttpBootTypeMax",
  .EnumValue_6 = HttpBootTypeMax
};
...
typedef struct _TYPE__gEfiHttpBootCallbackProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiHttpBootCallbackProtocolGuid;

TYPE__gEfiHttpBootCallbackProtocolGuid TypeInfo__gEfiHttpBootCallbackProtocolGuid = {
  .TypeName = "gEfiHttpBootCallbackProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiHttpBootCallbackProtocolGuid,
  .InterfaceStructName = "EFI_HTTP_BOOT_CALLBACK_PROTOCOL"
};
...
typedef struct _TYPE__gEfiHttpProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiHttpProtocolGuid;

TYPE__gEfiHttpProtocolGuid TypeInfo__gEfiHttpProtocolGuid = {
  .TypeName = "gEfiHttpProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiHttpProtocolGuid,
  .InterfaceStructName = "EFI_HTTP_PROTOCOL"
};
...
void *TypeInfoList_OpenProtocol[] = {
  ...
  &TypeInfo__gEfiHttpProtocolGuid,
...
void *TypeInfoList_InstallProtocolInterface[] = {
  &TypeInfo__gEfiHttpBootCallbackProtocolGuid,
  NULL
};
...
void *TypeInfoList[] = {
  ...
  &TypeInfo__EFI_HTTP_BOOT_CALLBACK_PROTOCOL,
  &TypeInfo__EFI_HTTP_BOOT_CALLBACK,
  &TypeInfo__EFI_HTTP_BOOT_CALLBACK_PROTOCOL_STAR,
  &TypeInfo__EFI_HTTP_BOOT_CALLBACK_DATA_TYPE,
  &TypeInfo__void_STAR,
  &TypeInfo__gEfiLoadFileProtocolGuid,
