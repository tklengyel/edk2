...
typedef struct _TYPE__gEfiAtaPassThruProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiAtaPassThruProtocolGuid;

TYPE__gEfiAtaPassThruProtocolGuid TypeInfo__gEfiAtaPassThruProtocolGuid = {
  .TypeName = "gEfiAtaPassThruProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiAtaPassThruProtocolGuid,
  .InterfaceStructName = "EFI_ATA_PASS_THRU_PROTOCOL"
};


typedef struct _TYPE__EFI_ATA_PASS_THRU_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
...
} TYPE__EFI_ATA_PASS_THRU_PROTOCOL;

TYPE__EFI_ATA_PASS_THRU_PROTOCOL TypeInfo__EFI_ATA_PASS_THRU_PROTOCOL = {
  .TypeName = "EFI_ATA_PASS_THRU_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_PROTOCOL),
  .StructFieldNum = 8,
  .StructFieldName_1 = "Mode",
  .StructFieldTypeName_1 = "EFI_ATA_PASS_THRU_MODE*",
  .StructFieldName_2 = "PassThru",
  .StructFieldTypeName_2 = "EFI_ATA_PASS_THRU_PASSTHRU",
  .StructFieldName_3 = "GetNextPort",
  .StructFieldTypeName_3 = "EFI_ATA_PASS_THRU_GET_NEXT_PORT",
  .StructFieldName_4 = "GetNextDevice",
  .StructFieldTypeName_4 = "EFI_ATA_PASS_THRU_GET_NEXT_DEVICE",
  .StructFieldName_5 = "BuildDevicePath",
  .StructFieldTypeName_5 = "EFI_ATA_PASS_THRU_BUILD_DEVICE_PATH",
  .StructFieldName_6 = "GetDevice",
  .StructFieldTypeName_6 = "EFI_ATA_PASS_THRU_GET_DEVICE",
  .StructFieldName_7 = "ResetPort",
  .StructFieldTypeName_7 = "EFI_ATA_PASS_THRU_RESET_PORT",
  .StructFieldName_8 = "ResetDevice",
  .StructFieldTypeName_8 = "EFI_ATA_PASS_THRU_RESET_DEVICE"
};


typedef struct _TYPE__EFI_ATA_PASS_THRU_MODE_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ATA_PASS_THRU_MODE_STAR;

TYPE__EFI_ATA_PASS_THRU_MODE_STAR TypeInfo__EFI_ATA_PASS_THRU_MODE_STAR = {
  .TypeName = "EFI_ATA_PASS_THRU_MODE*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_MODE*),
  .PointedType = "EFI_ATA_PASS_THRU_MODE"
};


typedef struct _TYPE__EFI_ATA_PASS_THRU_MODE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_2;
  const CHAR8* StructFieldTypeName_2;
} TYPE__EFI_ATA_PASS_THRU_MODE;

TYPE__EFI_ATA_PASS_THRU_MODE TypeInfo__EFI_ATA_PASS_THRU_MODE = {
  .TypeName = "EFI_ATA_PASS_THRU_MODE",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_MODE),
  .StructFieldNum = 2,
...
typedef struct _TYPE__EFI_ATA_PASS_THRU_PASSTHRU{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_5;
  const CHAR8* ParameterTypeName_5;
} TYPE__EFI_ATA_PASS_THRU_PASSTHRU;

TYPE__EFI_ATA_PASS_THRU_PASSTHRU TypeInfo__EFI_ATA_PASS_THRU_PASSTHRU = {
  .TypeName = "EFI_ATA_PASS_THRU_PASSTHRU",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_PASSTHRU),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 5,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_ATA_PASS_THRU_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "UINT16",
  .ParameterInOut_3 = IO_IN,
  .ParameterTypeName_3 = "UINT16",
  .ParameterInOut_4 = IO_IN,
  .ParameterTypeName_4 = "EFI_ATA_PASS_THRU_COMMAND_PACKET*",
  .ParameterInOut_5 = IO_IN,
  .ParameterTypeName_5 = "EFI_EVENT"
};


typedef struct _TYPE__EFI_ATA_PASS_THRU_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ATA_PASS_THRU_PROTOCOL_STAR;

TYPE__EFI_ATA_PASS_THRU_PROTOCOL_STAR TypeInfo__EFI_ATA_PASS_THRU_PROTOCOL_STAR = {
  .TypeName = "EFI_ATA_PASS_THRU_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_PROTOCOL*),
  .PointedType = "EFI_ATA_PASS_THRU_PROTOCOL"
};
...
typedef struct _TYPE__EFI_ATA_PASS_THRU_COMMAND_PACKET_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ATA_PASS_THRU_COMMAND_PACKET_STAR;

TYPE__EFI_ATA_PASS_THRU_COMMAND_PACKET_STAR TypeInfo__EFI_ATA_PASS_THRU_COMMAND_PACKET_STAR = {
  .TypeName = "EFI_ATA_PASS_THRU_COMMAND_PACKET*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_COMMAND_PACKET*),
  .PointedType = "EFI_ATA_PASS_THRU_COMMAND_PACKET"
};


typedef struct _TYPE__EFI_ATA_PASS_THRU_COMMAND_PACKET{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
...
} TYPE__EFI_ATA_PASS_THRU_COMMAND_PACKET;

TYPE__EFI_ATA_PASS_THRU_COMMAND_PACKET TypeInfo__EFI_ATA_PASS_THRU_COMMAND_PACKET = {
  .TypeName = "EFI_ATA_PASS_THRU_COMMAND_PACKET",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_COMMAND_PACKET),
  .StructFieldNum = 9,
  .StructFieldName_1 = "Asb",
  .StructFieldTypeName_1 = "EFI_ATA_STATUS_BLOCK*",
  .StructFieldName_2 = "Acb",
  .StructFieldTypeName_2 = "EFI_ATA_COMMAND_BLOCK*",
  .StructFieldName_3 = "Timeout",
  .StructFieldTypeName_3 = "UINT64",
  .StructFieldName_4 = "InDataBuffer",
  .StructFieldTypeName_4 = "void*",
  .StructFieldName_5 = "OutDataBuffer",
  ...
  .StructFieldName_8 = "Protocol",
  .StructFieldTypeName_8 = "EFI_ATA_PASS_THRU_CMD_PROTOCOL",
  .StructFieldName_9 = "Length",
  .StructFieldTypeName_9 = "EFI_ATA_PASS_THRU_LENGTH"
};


typedef struct _TYPE__EFI_ATA_STATUS_BLOCK_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ATA_STATUS_BLOCK_STAR;

TYPE__EFI_ATA_STATUS_BLOCK_STAR TypeInfo__EFI_ATA_STATUS_BLOCK_STAR = {
  .TypeName = "EFI_ATA_STATUS_BLOCK*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_ATA_STATUS_BLOCK*),
  .PointedType = "EFI_ATA_STATUS_BLOCK"
};


typedef struct _TYPE__EFI_ATA_STATUS_BLOCK{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
...
} TYPE__EFI_ATA_STATUS_BLOCK;

TYPE__EFI_ATA_STATUS_BLOCK TypeInfo__EFI_ATA_STATUS_BLOCK = {
  .TypeName = "EFI_ATA_STATUS_BLOCK",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_ATA_STATUS_BLOCK),
  .StructFieldNum = 14,
  .StructFieldName_1 = "Reserved1",
  .StructFieldTypeName_1 = "UINT8[2]",
  .StructFieldName_2 = "AtaStatus",
  .StructFieldTypeName_2 = "UINT8",
  .StructFieldName_3 = "AtaError",
  .StructFieldTypeName_3 = "UINT8",
  .StructFieldName_4 = "AtaSectorNumber",
  .StructFieldTypeName_4 = "UINT8",
  .StructFieldName_5 = "AtaCylinderLow",
  .StructFieldTypeName_5 = "UINT8",
  .StructFieldName_6 = "AtaCylinderHigh",
  .StructFieldTypeName_6 = "UINT8",
  .StructFieldName_7 = "AtaDeviceHead",
  .StructFieldTypeName_7 = "UINT8",
  .StructFieldName_8 = "AtaSectorNumberExp",
  .StructFieldTypeName_8 = "UINT8",
  .StructFieldName_9 = "AtaCylinderLowExp",
  .StructFieldTypeName_9 = "UINT8",
  .StructFieldName_10 = "AtaCylinderHighExp",
  .StructFieldTypeName_10 = "UINT8",
  .StructFieldName_11 = "Reserved2",
  .StructFieldTypeName_11 = "UINT8",
  .StructFieldName_12 = "AtaSectorCount",
  .StructFieldTypeName_12 = "UINT8",
  .StructFieldName_13 = "AtaSectorCountExp",
  .StructFieldTypeName_13 = "UINT8",
  .StructFieldName_14 = "Reserved3",
...
typedef struct _TYPE__EFI_ATA_COMMAND_BLOCK_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ATA_COMMAND_BLOCK_STAR;

TYPE__EFI_ATA_COMMAND_BLOCK_STAR TypeInfo__EFI_ATA_COMMAND_BLOCK_STAR = {
  .TypeName = "EFI_ATA_COMMAND_BLOCK*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_ATA_COMMAND_BLOCK*),
  .PointedType = "EFI_ATA_COMMAND_BLOCK"
};


typedef struct _TYPE__EFI_ATA_COMMAND_BLOCK{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_14;
  const CHAR8* StructFieldTypeName_14;
} TYPE__EFI_ATA_COMMAND_BLOCK;

TYPE__EFI_ATA_COMMAND_BLOCK TypeInfo__EFI_ATA_COMMAND_BLOCK = {
  .TypeName = "EFI_ATA_COMMAND_BLOCK",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_ATA_COMMAND_BLOCK),
  .StructFieldNum = 14,
  .StructFieldName_1 = "Reserved1",
  .StructFieldTypeName_1 = "UINT8[2]",
  .StructFieldName_2 = "AtaCommand",
  .StructFieldTypeName_2 = "UINT8",
  .StructFieldName_3 = "AtaFeatures",
  .StructFieldTypeName_3 = "UINT8",
  .StructFieldName_4 = "AtaSectorNumber",
  .StructFieldTypeName_4 = "UINT8",
  .StructFieldName_5 = "AtaCylinderLow",
  ...
  .StructFieldName_10 = "AtaCylinderHighExp",
  .StructFieldTypeName_10 = "UINT8",
  .StructFieldName_11 = "AtaFeaturesExp",
  .StructFieldTypeName_11 = "UINT8",
  .StructFieldName_12 = "AtaSectorCount",
  .StructFieldTypeName_12 = "UINT8",
  .StructFieldName_13 = "AtaSectorCountExp",
  .StructFieldTypeName_13 = "UINT8",
  .StructFieldName_14 = "Reserved2",
  .StructFieldTypeName_14 = "UINT8[6]"
};


typedef struct _TYPE__EFI_ATA_PASS_THRU_CMD_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* BasicTypeName;
} TYPE__EFI_ATA_PASS_THRU_CMD_PROTOCOL;

TYPE__EFI_ATA_PASS_THRU_CMD_PROTOCOL TypeInfo__EFI_ATA_PASS_THRU_CMD_PROTOCOL = {
  .TypeName = "EFI_ATA_PASS_THRU_CMD_PROTOCOL",
  .TypeClass = TYPE_CLASS_BASIC,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_CMD_PROTOCOL),
  .BasicTypeName = "UINT8"
};


typedef struct _TYPE__EFI_ATA_PASS_THRU_LENGTH{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* BasicTypeName;
} TYPE__EFI_ATA_PASS_THRU_LENGTH;

TYPE__EFI_ATA_PASS_THRU_LENGTH TypeInfo__EFI_ATA_PASS_THRU_LENGTH = {
  .TypeName = "EFI_ATA_PASS_THRU_LENGTH",
  .TypeClass = TYPE_CLASS_BASIC,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_LENGTH),
  .BasicTypeName = "UINT8"
};
...
typedef struct _TYPE__EFI_ATA_PASS_THRU_GET_NEXT_PORT{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_ATA_PASS_THRU_GET_NEXT_PORT;

TYPE__EFI_ATA_PASS_THRU_GET_NEXT_PORT TypeInfo__EFI_ATA_PASS_THRU_GET_NEXT_PORT = {
  .TypeName = "EFI_ATA_PASS_THRU_GET_NEXT_PORT",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_GET_NEXT_PORT),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_ATA_PASS_THRU_GET_NEXT_DEVICE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_3;
  const CHAR8* ParameterTypeName_3;
} TYPE__EFI_ATA_PASS_THRU_GET_NEXT_DEVICE;

TYPE__EFI_ATA_PASS_THRU_GET_NEXT_DEVICE TypeInfo__EFI_ATA_PASS_THRU_GET_NEXT_DEVICE = {
  .TypeName = "EFI_ATA_PASS_THRU_GET_NEXT_DEVICE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_GET_NEXT_DEVICE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_ATA_PASS_THRU_BUILD_DEVICE_PATH{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_4;
  const CHAR8* ParameterTypeName_4;
} TYPE__EFI_ATA_PASS_THRU_BUILD_DEVICE_PATH;

TYPE__EFI_ATA_PASS_THRU_BUILD_DEVICE_PATH TypeInfo__EFI_ATA_PASS_THRU_BUILD_DEVICE_PATH = {
  .TypeName = "EFI_ATA_PASS_THRU_BUILD_DEVICE_PATH",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_BUILD_DEVICE_PATH),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 4,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_ATA_PASS_THRU_GET_DEVICE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_4;
  const CHAR8* ParameterTypeName_4;
} TYPE__EFI_ATA_PASS_THRU_GET_DEVICE;

TYPE__EFI_ATA_PASS_THRU_GET_DEVICE TypeInfo__EFI_ATA_PASS_THRU_GET_DEVICE = {
  .TypeName = "EFI_ATA_PASS_THRU_GET_DEVICE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_GET_DEVICE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 4,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_ATA_PASS_THRU_RESET_PORT{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_ATA_PASS_THRU_RESET_PORT;

TYPE__EFI_ATA_PASS_THRU_RESET_PORT TypeInfo__EFI_ATA_PASS_THRU_RESET_PORT = {
  .TypeName = "EFI_ATA_PASS_THRU_RESET_PORT",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_RESET_PORT),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_ATA_PASS_THRU_RESET_DEVICE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_3;
  const CHAR8* ParameterTypeName_3;
} TYPE__EFI_ATA_PASS_THRU_RESET_DEVICE;

TYPE__EFI_ATA_PASS_THRU_RESET_DEVICE TypeInfo__EFI_ATA_PASS_THRU_RESET_DEVICE = {
  .TypeName = "EFI_ATA_PASS_THRU_RESET_DEVICE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_ATA_PASS_THRU_RESET_DEVICE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
...
void *TypeInfoList_OpenProtocol[] = {
  ...
  &TypeInfo__gEfiAtaPassThruProtocolGuid,
...
void *TypeInfoList[] = {
  ...
  &TypeInfo__gEfiAtaPassThruProtocolGuid,
  &TypeInfo__EFI_ATA_PASS_THRU_PROTOCOL,
  &TypeInfo__EFI_ATA_PASS_THRU_MODE_STAR,
  &TypeInfo__EFI_ATA_PASS_THRU_MODE,
  &TypeInfo__EFI_ATA_PASS_THRU_PASSTHRU,
  &TypeInfo__EFI_ATA_PASS_THRU_PROTOCOL_STAR,
  &TypeInfo__UINT16,
  &TypeInfo__EFI_ATA_PASS_THRU_COMMAND_PACKET_STAR,
  &TypeInfo__EFI_ATA_PASS_THRU_COMMAND_PACKET,
  &TypeInfo__EFI_ATA_STATUS_BLOCK_STAR,
  &TypeInfo__EFI_ATA_STATUS_BLOCK,
  &TypeInfo__UINT8_ARRAY_6,
  &TypeInfo__EFI_ATA_COMMAND_BLOCK_STAR,
  &TypeInfo__EFI_ATA_COMMAND_BLOCK,
  &TypeInfo__EFI_ATA_PASS_THRU_CMD_PROTOCOL,
  &TypeInfo__EFI_ATA_PASS_THRU_LENGTH,
  &TypeInfo__EFI_EVENT,
  &TypeInfo__EFI_ATA_PASS_THRU_GET_NEXT_PORT,
  &TypeInfo__UINT16_STAR,
  &TypeInfo__EFI_ATA_PASS_THRU_GET_NEXT_DEVICE,
  &TypeInfo__EFI_ATA_PASS_THRU_BUILD_DEVICE_PATH,
  &TypeInfo__EFI_DEVICE_PATH_PROTOCOL_STAR_STAR,
  &TypeInfo__EFI_ATA_PASS_THRU_GET_DEVICE,
  &TypeInfo__EFI_ATA_PASS_THRU_RESET_PORT,
  &TypeInfo__EFI_ATA_PASS_THRU_RESET_DEVICE,
  &TypeInfo__gEfiExtScsiPassThruProtocolGuid,
