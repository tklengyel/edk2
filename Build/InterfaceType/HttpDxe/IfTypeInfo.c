...
typedef struct _TYPE__EFI_HTTP_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
...
} TYPE__EFI_HTTP_PROTOCOL;

TYPE__EFI_HTTP_PROTOCOL TypeInfo__EFI_HTTP_PROTOCOL = {
  .TypeName = "EFI_HTTP_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_HTTP_PROTOCOL),
  .StructFieldNum = 6,
  .StructFieldName_1 = "GetModeData",
  .StructFieldTypeName_1 = "EFI_HTTP_GET_MODE_DATA",
  .StructFieldName_2 = "Configure",
  .StructFieldTypeName_2 = "EFI_HTTP_CONFIGURE",
  .StructFieldName_3 = "Request",
  .StructFieldTypeName_3 = "EFI_HTTP_REQUEST",
  .StructFieldName_4 = "Cancel",
  .StructFieldTypeName_4 = "EFI_HTTP_CANCEL",
  .StructFieldName_5 = "Response",
  .StructFieldTypeName_5 = "EFI_HTTP_RESPONSE",
  .StructFieldName_6 = "Poll",
  .StructFieldTypeName_6 = "EFI_HTTP_POLL"
};


typedef struct _TYPE__EFI_HTTP_GET_MODE_DATA{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_HTTP_GET_MODE_DATA;

TYPE__EFI_HTTP_GET_MODE_DATA TypeInfo__EFI_HTTP_GET_MODE_DATA = {
  .TypeName = "EFI_HTTP_GET_MODE_DATA",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_HTTP_GET_MODE_DATA),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_HTTP_PROTOCOL*",
  .ParameterInOut_2 = IO_OUT,
  .ParameterTypeName_2 = "EFI_HTTP_CONFIG_DATA*"
};


typedef struct _TYPE__EFI_HTTP_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_HTTP_PROTOCOL_STAR;

TYPE__EFI_HTTP_PROTOCOL_STAR TypeInfo__EFI_HTTP_PROTOCOL_STAR = {
  .TypeName = "EFI_HTTP_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_HTTP_PROTOCOL*),
  .PointedType = "EFI_HTTP_PROTOCOL"
};


typedef struct _TYPE__EFI_HTTP_CONFIG_DATA_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_HTTP_CONFIG_DATA_STAR;

TYPE__EFI_HTTP_CONFIG_DATA_STAR TypeInfo__EFI_HTTP_CONFIG_DATA_STAR = {
  .TypeName = "EFI_HTTP_CONFIG_DATA*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_HTTP_CONFIG_DATA*),
  .PointedType = "EFI_HTTP_CONFIG_DATA"
};


typedef struct _TYPE__EFI_HTTP_CONFIG_DATA{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_4;
  const CHAR8* StructFieldTypeName_4;
} TYPE__EFI_HTTP_CONFIG_DATA;

TYPE__EFI_HTTP_CONFIG_DATA TypeInfo__EFI_HTTP_CONFIG_DATA = {
  .TypeName = "EFI_HTTP_CONFIG_DATA",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_HTTP_CONFIG_DATA),
  .StructFieldNum = 4,
  .StructFieldName_1 = "HttpVersion",
  .StructFieldTypeName_1 = "EFI_HTTP_VERSION",
  .StructFieldName_2 = "TimeOutMillisec",
  .StructFieldTypeName_2 = "UINT32",
  .StructFieldName_3 = "LocalAddressIsIPv6",
  .StructFieldTypeName_3 = "BOOLEAN",
  .StructFieldName_4 = "AccessPoint",
  .StructFieldTypeName_4 = "union(anonymousunionat/home/jshi19/wksp_efi/simicsx58_bios_udk2017-simicsx58_edk2/MdePkg/Include/Protocol/Http.h:172:3)"
};


typedef struct _TYPE__EFI_HTTP_VERSION{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
...
} TYPE__EFI_HTTP_VERSION;

TYPE__EFI_HTTP_VERSION TypeInfo__EFI_HTTP_VERSION = {
  .TypeName = "EFI_HTTP_VERSION",
  .TypeClass = TYPE_CLASS_ENUM,
  .TypeSize = sizeof(EFI_HTTP_VERSION),
  .EnumValueNum = 3,
  .EnumValueName_1 = "HttpVersion10",
  .EnumValue_1 = HttpVersion10,
  .EnumValueName_2 = "HttpVersion11",
  .EnumValue_2 = HttpVersion11,
  .EnumValueName_3 = "HttpVersionUnsupported",
  .EnumValue_3 = HttpVersionUnsupported
};
...
typedef struct _TYPE__EFI_HTTP_CONFIGURE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_HTTP_CONFIGURE;

TYPE__EFI_HTTP_CONFIGURE TypeInfo__EFI_HTTP_CONFIGURE = {
  .TypeName = "EFI_HTTP_CONFIGURE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_HTTP_CONFIGURE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_HTTP_REQUEST{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_HTTP_REQUEST;

TYPE__EFI_HTTP_REQUEST TypeInfo__EFI_HTTP_REQUEST = {
  .TypeName = "EFI_HTTP_REQUEST",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_HTTP_REQUEST),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_HTTP_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "EFI_HTTP_TOKEN*"
};


typedef struct _TYPE__EFI_HTTP_TOKEN_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_HTTP_TOKEN_STAR;

TYPE__EFI_HTTP_TOKEN_STAR TypeInfo__EFI_HTTP_TOKEN_STAR = {
  .TypeName = "EFI_HTTP_TOKEN*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_HTTP_TOKEN*),
  .PointedType = "EFI_HTTP_TOKEN"
};


typedef struct _TYPE__EFI_HTTP_TOKEN{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_3;
  const CHAR8* StructFieldTypeName_3;
} TYPE__EFI_HTTP_TOKEN;

TYPE__EFI_HTTP_TOKEN TypeInfo__EFI_HTTP_TOKEN = {
  .TypeName = "EFI_HTTP_TOKEN",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_HTTP_TOKEN),
  .StructFieldNum = 3,
  ...
  .StructFieldName_3 = "Message",
  .StructFieldTypeName_3 = "EFI_HTTP_MESSAGE*"
};
...
typedef struct _TYPE__EFI_HTTP_MESSAGE_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_HTTP_MESSAGE_STAR;

TYPE__EFI_HTTP_MESSAGE_STAR TypeInfo__EFI_HTTP_MESSAGE_STAR = {
  .TypeName = "EFI_HTTP_MESSAGE*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_HTTP_MESSAGE*),
  .PointedType = "EFI_HTTP_MESSAGE"
};


typedef struct _TYPE__EFI_HTTP_MESSAGE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_5;
  const CHAR8* StructFieldTypeName_5;
} TYPE__EFI_HTTP_MESSAGE;

TYPE__EFI_HTTP_MESSAGE TypeInfo__EFI_HTTP_MESSAGE = {
  .TypeName = "EFI_HTTP_MESSAGE",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_HTTP_MESSAGE),
  .StructFieldNum = 5,
  .StructFieldName_1 = "Data",
  .StructFieldTypeName_1 = "union(anonymousunionat/home/jshi19/wksp_efi/simicsx58_bios_udk2017-simicsx58_edk2/MdePkg/Include/Protocol/Http.h:236:3)",
  .StructFieldName_2 = "HeaderCount",
  .StructFieldTypeName_2 = "UINTN",
  .StructFieldName_3 = "Headers",
  .StructFieldTypeName_3 = "EFI_HTTP_HEADER*",
  .StructFieldName_4 = "BodyLength",
  .StructFieldTypeName_4 = "UINTN",
  .StructFieldName_5 = "Body",
...
typedef struct _TYPE__EFI_HTTP_CANCEL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_HTTP_CANCEL;

TYPE__EFI_HTTP_CANCEL TypeInfo__EFI_HTTP_CANCEL = {
  .TypeName = "EFI_HTTP_CANCEL",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_HTTP_CANCEL),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_HTTP_RESPONSE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_HTTP_RESPONSE;

TYPE__EFI_HTTP_RESPONSE TypeInfo__EFI_HTTP_RESPONSE = {
  .TypeName = "EFI_HTTP_RESPONSE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_HTTP_RESPONSE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_HTTP_POLL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
...
TYPE__EFI_HTTP_POLL TypeInfo__EFI_HTTP_POLL = {
  .TypeName = "EFI_HTTP_POLL",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_HTTP_POLL),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 1,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__gEfiHttpServiceBindingProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiHttpServiceBindingProtocolGuid;

TYPE__gEfiHttpServiceBindingProtocolGuid TypeInfo__gEfiHttpServiceBindingProtocolGuid = {
  .TypeName = "gEfiHttpServiceBindingProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiHttpServiceBindingProtocolGuid,
  .InterfaceStructName = "EFI_SERVICE_BINDING_PROTOCOL"
};
...
void *TypeInfoList_OpenProtocol[] = {
  ...
  &TypeInfo__gEfiHttpServiceBindingProtocolGuid,
...
void *TypeInfoList[] = {
  ...
  &TypeInfo__gEfiHttpProtocolGuid,
  &TypeInfo__EFI_HTTP_PROTOCOL,
  &TypeInfo__EFI_HTTP_GET_MODE_DATA,
  &TypeInfo__EFI_HTTP_PROTOCOL_STAR,
  &TypeInfo__EFI_HTTP_CONFIG_DATA_STAR,
  &TypeInfo__EFI_HTTP_CONFIG_DATA,
  &TypeInfo__EFI_HTTP_VERSION,
  &TypeInfo__UINT32,
  &TypeInfo__BOOLEAN,
  &TypeInfo__EFI_HTTP_CONFIGURE,
  &TypeInfo__EFI_HTTP_REQUEST,
  &TypeInfo__EFI_HTTP_TOKEN_STAR,
  &TypeInfo__EFI_HTTP_TOKEN,
  &TypeInfo__EFI_EVENT,
  &TypeInfo__EFI_HTTP_MESSAGE_STAR,
  &TypeInfo__EFI_HTTP_MESSAGE,
  &TypeInfo__EFI_HTTP_HEADER_STAR,
  &TypeInfo__EFI_HTTP_HEADER,
  &TypeInfo__CHAR8_STAR,
  &TypeInfo__CHAR8,
  &TypeInfo__EFI_HTTP_CANCEL,
  &TypeInfo__EFI_HTTP_RESPONSE,
  &TypeInfo__EFI_HTTP_POLL,
  &TypeInfo__gEfiDriverBindingProtocolGuid,
