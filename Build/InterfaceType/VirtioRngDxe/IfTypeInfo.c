...
typedef struct _TYPE__gEfiRngProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiRngProtocolGuid;

TYPE__gEfiRngProtocolGuid TypeInfo__gEfiRngProtocolGuid = {
  .TypeName = "gEfiRngProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiRngProtocolGuid,
  .InterfaceStructName = "EFI_RNG_PROTOCOL"
};


typedef struct _TYPE__EFI_RNG_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_2;
  const CHAR8* StructFieldTypeName_2;
} TYPE__EFI_RNG_PROTOCOL;

TYPE__EFI_RNG_PROTOCOL TypeInfo__EFI_RNG_PROTOCOL = {
  .TypeName = "EFI_RNG_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_RNG_PROTOCOL),
  .StructFieldNum = 2,
  .StructFieldName_1 = "GetInfo",
  .StructFieldTypeName_1 = "EFI_RNG_GET_INFO",
  .StructFieldName_2 = "GetRNG",
  .StructFieldTypeName_2 = "EFI_RNG_GET_RNG"
};


typedef struct _TYPE__EFI_RNG_GET_INFO{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_3;
  const CHAR8* ParameterTypeName_3;
} TYPE__EFI_RNG_GET_INFO;

TYPE__EFI_RNG_GET_INFO TypeInfo__EFI_RNG_GET_INFO = {
  .TypeName = "EFI_RNG_GET_INFO",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_RNG_GET_INFO),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_RNG_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "UINTN*",
  .ParameterInOut_3 = IO_OUT,
  .ParameterTypeName_3 = "EFI_RNG_ALGORITHM*"
};


typedef struct _TYPE__EFI_RNG_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_RNG_PROTOCOL_STAR;

TYPE__EFI_RNG_PROTOCOL_STAR TypeInfo__EFI_RNG_PROTOCOL_STAR = {
  .TypeName = "EFI_RNG_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_RNG_PROTOCOL*),
  .PointedType = "EFI_RNG_PROTOCOL"
};
...
typedef struct _TYPE__EFI_RNG_ALGORITHM_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_RNG_ALGORITHM_STAR;

TYPE__EFI_RNG_ALGORITHM_STAR TypeInfo__EFI_RNG_ALGORITHM_STAR = {
  .TypeName = "EFI_RNG_ALGORITHM*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_RNG_ALGORITHM*),
  .PointedType = "EFI_RNG_ALGORITHM"
};


typedef struct _TYPE__EFI_RNG_ALGORITHM{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_4;
  const CHAR8* StructFieldTypeName_4;
} TYPE__EFI_RNG_ALGORITHM;

TYPE__EFI_RNG_ALGORITHM TypeInfo__EFI_RNG_ALGORITHM = {
  .TypeName = "EFI_RNG_ALGORITHM",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_RNG_ALGORITHM),
  .StructFieldNum = 4,
...
typedef struct _TYPE__EFI_RNG_GET_RNG{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_4;
  const CHAR8* ParameterTypeName_4;
} TYPE__EFI_RNG_GET_RNG;

TYPE__EFI_RNG_GET_RNG TypeInfo__EFI_RNG_GET_RNG = {
  .TypeName = "EFI_RNG_GET_RNG",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_RNG_GET_RNG),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 4,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_RNG_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "EFI_RNG_ALGORITHM*",
  .ParameterInOut_3 = IO_IN,
  .ParameterTypeName_3 = "UINTN",
...
void *TypeInfoList[] = {
  ...
  &TypeInfo__gEfiRngProtocolGuid,
  &TypeInfo__EFI_RNG_PROTOCOL,
  &TypeInfo__EFI_RNG_GET_INFO,
  &TypeInfo__EFI_RNG_PROTOCOL_STAR,
  &TypeInfo__UINTN_STAR,
  &TypeInfo__EFI_RNG_ALGORITHM_STAR,
  &TypeInfo__EFI_RNG_ALGORITHM,
  &TypeInfo__UINT16,
  &TypeInfo__UINT8_ARRAY_8,
  &TypeInfo__EFI_RNG_GET_RNG,
