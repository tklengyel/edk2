...
typedef struct _TYPE__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_2;
  const CHAR8* StructFieldTypeName_2;
} TYPE__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL;

TYPE__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL TypeInfo__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL = {
  .TypeName = "EFI_SIMPLE_FILE_SYSTEM_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_SIMPLE_FILE_SYSTEM_PROTOCOL),
  .StructFieldNum = 2,
  .StructFieldName_1 = "Revision",
  .StructFieldTypeName_1 = "UINT64",
  .StructFieldName_2 = "OpenVolume",
  .StructFieldTypeName_2 = "EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_OPEN_VOLUME"
};


typedef struct _TYPE__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_OPEN_VOLUME{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_OPEN_VOLUME;

TYPE__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_OPEN_VOLUME TypeInfo__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_OPEN_VOLUME = {
  .TypeName = "EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_OPEN_VOLUME",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_OPEN_VOLUME),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_SIMPLE_FILE_SYSTEM_PROTOCOL*",
  .ParameterInOut_2 = IO_OUT,
  .ParameterTypeName_2 = "EFI_FILE_PROTOCOL**"
};


typedef struct _TYPE__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_STAR;

TYPE__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_STAR TypeInfo__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_STAR = {
  .TypeName = "EFI_SIMPLE_FILE_SYSTEM_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_SIMPLE_FILE_SYSTEM_PROTOCOL*),
  .PointedType = "EFI_SIMPLE_FILE_SYSTEM_PROTOCOL"
};


typedef struct _TYPE__EFI_FILE_PROTOCOL_STAR_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_FILE_PROTOCOL_STAR_STAR;

TYPE__EFI_FILE_PROTOCOL_STAR_STAR TypeInfo__EFI_FILE_PROTOCOL_STAR_STAR = {
  .TypeName = "EFI_FILE_PROTOCOL**",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_FILE_PROTOCOL**),
  .PointedType = "EFI_FILE_PROTOCOL*"
};


typedef struct _TYPE__EFI_FILE_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_FILE_PROTOCOL_STAR;

TYPE__EFI_FILE_PROTOCOL_STAR TypeInfo__EFI_FILE_PROTOCOL_STAR = {
  .TypeName = "EFI_FILE_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_FILE_PROTOCOL*),
  .PointedType = "EFI_FILE_PROTOCOL"
...
typedef struct _TYPE__EFI_FILE_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
...
} TYPE__EFI_FILE_PROTOCOL;

TYPE__EFI_FILE_PROTOCOL TypeInfo__EFI_FILE_PROTOCOL = {
  .TypeName = "EFI_FILE_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_FILE_PROTOCOL),
  .StructFieldNum = 15,
  .StructFieldName_1 = "Revision",
  .StructFieldTypeName_1 = "UINT64",
  .StructFieldName_2 = "Open",
  .StructFieldTypeName_2 = "EFI_FILE_OPEN",
  .StructFieldName_3 = "Close",
  .StructFieldTypeName_3 = "EFI_FILE_CLOSE",
  .StructFieldName_4 = "Delete",
  .StructFieldTypeName_4 = "EFI_FILE_DELETE",
  .StructFieldName_5 = "Read",
  .StructFieldTypeName_5 = "EFI_FILE_READ",
  .StructFieldName_6 = "Write",
  .StructFieldTypeName_6 = "EFI_FILE_WRITE",
  .StructFieldName_7 = "GetPosition",
  .StructFieldTypeName_7 = "EFI_FILE_GET_POSITION",
  .StructFieldName_8 = "SetPosition",
  .StructFieldTypeName_8 = "EFI_FILE_SET_POSITION",
  .StructFieldName_9 = "GetInfo",
  .StructFieldTypeName_9 = "EFI_FILE_GET_INFO",
  .StructFieldName_10 = "SetInfo",
  .StructFieldTypeName_10 = "EFI_FILE_SET_INFO",
  .StructFieldName_11 = "Flush",
  .StructFieldTypeName_11 = "EFI_FILE_FLUSH",
  .StructFieldName_12 = "OpenEx",
  .StructFieldTypeName_12 = "EFI_FILE_OPEN_EX",
  .StructFieldName_13 = "ReadEx",
  .StructFieldTypeName_13 = "EFI_FILE_READ_EX",
  .StructFieldName_14 = "WriteEx",
  .StructFieldTypeName_14 = "EFI_FILE_WRITE_EX",
  .StructFieldName_15 = "FlushEx",
  .StructFieldTypeName_15 = "EFI_FILE_FLUSH_EX"
};


typedef struct _TYPE__EFI_FILE_OPEN{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
...
TYPE__EFI_FILE_OPEN TypeInfo__EFI_FILE_OPEN = {
  .TypeName = "EFI_FILE_OPEN",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_OPEN),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 5,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_FILE_PROTOCOL*",
  .ParameterInOut_2 = IO_OUT,
  .ParameterTypeName_2 = "EFI_FILE_PROTOCOL**",
  .ParameterInOut_3 = IO_IN,
  .ParameterTypeName_3 = "CHAR16*",
...
typedef struct _TYPE__EFI_FILE_CLOSE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_1;
  const CHAR8* ParameterTypeName_1;
} TYPE__EFI_FILE_CLOSE;

TYPE__EFI_FILE_CLOSE TypeInfo__EFI_FILE_CLOSE = {
  .TypeName = "EFI_FILE_CLOSE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_CLOSE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 1,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_FILE_DELETE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_1;
  const CHAR8* ParameterTypeName_1;
} TYPE__EFI_FILE_DELETE;

TYPE__EFI_FILE_DELETE TypeInfo__EFI_FILE_DELETE = {
  .TypeName = "EFI_FILE_DELETE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_DELETE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 1,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_FILE_READ{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
...
TYPE__EFI_FILE_READ TypeInfo__EFI_FILE_READ = {
  .TypeName = "EFI_FILE_READ",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_READ),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_FILE_WRITE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_3;
  const CHAR8* ParameterTypeName_3;
} TYPE__EFI_FILE_WRITE;

TYPE__EFI_FILE_WRITE TypeInfo__EFI_FILE_WRITE = {
  .TypeName = "EFI_FILE_WRITE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_WRITE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 3,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_FILE_GET_POSITION{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_FILE_GET_POSITION;

TYPE__EFI_FILE_GET_POSITION TypeInfo__EFI_FILE_GET_POSITION = {
  .TypeName = "EFI_FILE_GET_POSITION",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_GET_POSITION),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_FILE_SET_POSITION{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_FILE_SET_POSITION;

TYPE__EFI_FILE_SET_POSITION TypeInfo__EFI_FILE_SET_POSITION = {
  .TypeName = "EFI_FILE_SET_POSITION",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_SET_POSITION),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_FILE_GET_INFO{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_4;
  const CHAR8* ParameterTypeName_4;
} TYPE__EFI_FILE_GET_INFO;

TYPE__EFI_FILE_GET_INFO TypeInfo__EFI_FILE_GET_INFO = {
  .TypeName = "EFI_FILE_GET_INFO",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_GET_INFO),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 4,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_FILE_SET_INFO{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_4;
  const CHAR8* ParameterTypeName_4;
} TYPE__EFI_FILE_SET_INFO;

TYPE__EFI_FILE_SET_INFO TypeInfo__EFI_FILE_SET_INFO = {
  .TypeName = "EFI_FILE_SET_INFO",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_SET_INFO),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 4,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_FILE_FLUSH{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_1;
  const CHAR8* ParameterTypeName_1;
} TYPE__EFI_FILE_FLUSH;

TYPE__EFI_FILE_FLUSH TypeInfo__EFI_FILE_FLUSH = {
  .TypeName = "EFI_FILE_FLUSH",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_FLUSH),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 1,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_FILE_OPEN_EX{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
...
} TYPE__EFI_FILE_OPEN_EX;

TYPE__EFI_FILE_OPEN_EX TypeInfo__EFI_FILE_OPEN_EX = {
  .TypeName = "EFI_FILE_OPEN_EX",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_OPEN_EX),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 6,
  .ParameterInOut_1 = IO_IN,
  ...
  .ParameterTypeName_6 = "EFI_FILE_IO_TOKEN*"
};


typedef struct _TYPE__EFI_FILE_IO_TOKEN_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_FILE_IO_TOKEN_STAR;

TYPE__EFI_FILE_IO_TOKEN_STAR TypeInfo__EFI_FILE_IO_TOKEN_STAR = {
  .TypeName = "EFI_FILE_IO_TOKEN*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_FILE_IO_TOKEN*),
  .PointedType = "EFI_FILE_IO_TOKEN"
};


typedef struct _TYPE__EFI_FILE_IO_TOKEN{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_4;
  const CHAR8* StructFieldTypeName_4;
} TYPE__EFI_FILE_IO_TOKEN;

TYPE__EFI_FILE_IO_TOKEN TypeInfo__EFI_FILE_IO_TOKEN = {
  .TypeName = "EFI_FILE_IO_TOKEN",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_FILE_IO_TOKEN),
  .StructFieldNum = 4,
  ...
  .StructFieldName_3 = "BufferSize",
  .StructFieldTypeName_3 = "UINTN",
  .StructFieldName_4 = "Buffer",
...
typedef struct _TYPE__EFI_FILE_READ_EX{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_FILE_READ_EX;

TYPE__EFI_FILE_READ_EX TypeInfo__EFI_FILE_READ_EX = {
  .TypeName = "EFI_FILE_READ_EX",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_READ_EX),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_FILE_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "EFI_FILE_IO_TOKEN*"
};


typedef struct _TYPE__EFI_FILE_WRITE_EX{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_FILE_WRITE_EX;

TYPE__EFI_FILE_WRITE_EX TypeInfo__EFI_FILE_WRITE_EX = {
  .TypeName = "EFI_FILE_WRITE_EX",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_WRITE_EX),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__EFI_FILE_FLUSH_EX{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_2;
  const CHAR8* ParameterTypeName_2;
} TYPE__EFI_FILE_FLUSH_EX;

TYPE__EFI_FILE_FLUSH_EX TypeInfo__EFI_FILE_FLUSH_EX = {
  .TypeName = "EFI_FILE_FLUSH_EX",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_FILE_FLUSH_EX),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 2,
  .ParameterInOut_1 = IO_IN,
...
typedef struct _TYPE__gEfiDiskIoProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiDiskIoProtocolGuid;

TYPE__gEfiDiskIoProtocolGuid TypeInfo__gEfiDiskIoProtocolGuid = {
  .TypeName = "gEfiDiskIoProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiDiskIoProtocolGuid,
  .InterfaceStructName = "EFI_DISK_IO_PROTOCOL"
};
...
typedef struct _TYPE__gEfiDiskIo2ProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiDiskIo2ProtocolGuid;

TYPE__gEfiDiskIo2ProtocolGuid TypeInfo__gEfiDiskIo2ProtocolGuid = {
  .TypeName = "gEfiDiskIo2ProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiDiskIo2ProtocolGuid,
  .InterfaceStructName = "EFI_DISK_IO2_PROTOCOL"
};
...
void *TypeInfoList_OpenProtocol[] = {
  &TypeInfo__gEfiDiskIoProtocolGuid,
  &TypeInfo__gEfiBlockIoProtocolGuid,
  &TypeInfo__gEfiDiskIo2ProtocolGuid,
...
void *TypeInfoList[] = {
  ...
  &TypeInfo__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL,
  &TypeInfo__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_OPEN_VOLUME,
  &TypeInfo__EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_STAR,
  &TypeInfo__EFI_FILE_PROTOCOL_STAR_STAR,
  &TypeInfo__EFI_FILE_PROTOCOL_STAR,
  &TypeInfo__EFI_FILE_PROTOCOL,
  &TypeInfo__EFI_FILE_OPEN,
  &TypeInfo__EFI_FILE_CLOSE,
  &TypeInfo__EFI_FILE_DELETE,
  &TypeInfo__EFI_FILE_READ,
  &TypeInfo__UINTN_STAR,
  &TypeInfo__EFI_FILE_WRITE,
  &TypeInfo__EFI_FILE_GET_POSITION,
  &TypeInfo__UINT64_STAR,
  &TypeInfo__EFI_FILE_SET_POSITION,
  &TypeInfo__EFI_FILE_GET_INFO,
  &TypeInfo__EFI_GUID_STAR,
  &TypeInfo__EFI_GUID,
  &TypeInfo__UINT16,
  &TypeInfo__UINT8_ARRAY_8,
  &TypeInfo__EFI_FILE_SET_INFO,
  &TypeInfo__EFI_FILE_FLUSH,
  &TypeInfo__EFI_FILE_OPEN_EX,
  &TypeInfo__EFI_FILE_IO_TOKEN_STAR,
  &TypeInfo__EFI_FILE_IO_TOKEN,
  &TypeInfo__EFI_EVENT,
  &TypeInfo__EFI_FILE_READ_EX,
  &TypeInfo__EFI_FILE_WRITE_EX,
  &TypeInfo__EFI_FILE_FLUSH_EX,
  NULL
};