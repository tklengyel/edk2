...
typedef struct _TYPE__gEfiEraseBlockProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiEraseBlockProtocolGuid;

TYPE__gEfiEraseBlockProtocolGuid TypeInfo__gEfiEraseBlockProtocolGuid = {
  .TypeName = "gEfiEraseBlockProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiEraseBlockProtocolGuid,
  .InterfaceStructName = "EFI_ERASE_BLOCK_PROTOCOL"
};


typedef struct _TYPE__EFI_ERASE_BLOCK_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_3;
  const CHAR8* StructFieldTypeName_3;
} TYPE__EFI_ERASE_BLOCK_PROTOCOL;

TYPE__EFI_ERASE_BLOCK_PROTOCOL TypeInfo__EFI_ERASE_BLOCK_PROTOCOL = {
  .TypeName = "EFI_ERASE_BLOCK_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_ERASE_BLOCK_PROTOCOL),
  .StructFieldNum = 3,
  .StructFieldName_1 = "Revision",
  .StructFieldTypeName_1 = "UINT64",
  .StructFieldName_2 = "EraseLengthGranularity",
  .StructFieldTypeName_2 = "UINT32",
  .StructFieldName_3 = "EraseBlocks",
  .StructFieldTypeName_3 = "EFI_BLOCK_ERASE"
};


typedef struct _TYPE__EFI_BLOCK_ERASE{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ReturnType;
  ...
  const UINTN ParameterInOut_5;
  const CHAR8* ParameterTypeName_5;
} TYPE__EFI_BLOCK_ERASE;

TYPE__EFI_BLOCK_ERASE TypeInfo__EFI_BLOCK_ERASE = {
  .TypeName = "EFI_BLOCK_ERASE",
  .TypeClass = TYPE_CLASS_FUNCTION,
  .TypeSize = sizeof(EFI_BLOCK_ERASE),
  .ReturnType = "EFI_STATUS",
  .HasVarArg = FALSE,
  .ParameterNum = 5,
  .ParameterInOut_1 = IO_IN,
  .ParameterTypeName_1 = "EFI_ERASE_BLOCK_PROTOCOL*",
  .ParameterInOut_2 = IO_IN,
  .ParameterTypeName_2 = "UINT32",
  .ParameterInOut_3 = IO_IN,
  .ParameterTypeName_3 = "EFI_LBA",
  .ParameterInOut_4 = IO_IN,
  .ParameterTypeName_4 = "EFI_ERASE_BLOCK_TOKEN*",
  .ParameterInOut_5 = IO_IN,
  .ParameterTypeName_5 = "UINTN"
};


typedef struct _TYPE__EFI_ERASE_BLOCK_PROTOCOL_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ERASE_BLOCK_PROTOCOL_STAR;

TYPE__EFI_ERASE_BLOCK_PROTOCOL_STAR TypeInfo__EFI_ERASE_BLOCK_PROTOCOL_STAR = {
  .TypeName = "EFI_ERASE_BLOCK_PROTOCOL*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_ERASE_BLOCK_PROTOCOL*),
  .PointedType = "EFI_ERASE_BLOCK_PROTOCOL"
};


typedef struct _TYPE__EFI_ERASE_BLOCK_TOKEN_STAR{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* PointedType;
} TYPE__EFI_ERASE_BLOCK_TOKEN_STAR;

TYPE__EFI_ERASE_BLOCK_TOKEN_STAR TypeInfo__EFI_ERASE_BLOCK_TOKEN_STAR = {
  .TypeName = "EFI_ERASE_BLOCK_TOKEN*",
  .TypeClass = TYPE_CLASS_POINTER,
  .TypeSize = sizeof(EFI_ERASE_BLOCK_TOKEN*),
  .PointedType = "EFI_ERASE_BLOCK_TOKEN"
};


typedef struct _TYPE__EFI_ERASE_BLOCK_TOKEN{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_2;
  const CHAR8* StructFieldTypeName_2;
} TYPE__EFI_ERASE_BLOCK_TOKEN;

TYPE__EFI_ERASE_BLOCK_TOKEN TypeInfo__EFI_ERASE_BLOCK_TOKEN = {
  .TypeName = "EFI_ERASE_BLOCK_TOKEN",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_ERASE_BLOCK_TOKEN),
  .StructFieldNum = 2,
...
typedef struct _TYPE__gEfiScsiIoProtocolGuid{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const GUID* ProtocolGuid;
  const CHAR8* InterfaceStructName;
} TYPE__gEfiScsiIoProtocolGuid;

TYPE__gEfiScsiIoProtocolGuid TypeInfo__gEfiScsiIoProtocolGuid = {
  .TypeName = "gEfiScsiIoProtocolGuid",
  .TypeClass = TYPE_CLASS_PROTOCOL,
  .TypeSize = sizeof(GUID),
  .ProtocolGuid = &gEfiScsiIoProtocolGuid,
  .InterfaceStructName = "EFI_SCSI_IO_PROTOCOL"
};

void *TypeInfoList_OpenProtocol[] = {
  &TypeInfo__gEfiBlockIoProtocolGuid,
  &TypeInfo__gEfiScsiIoProtocolGuid,
  &TypeInfo__gEfiEraseBlockProtocolGuid,
  NULL
};
...
void *TypeInfoList[] = {
  ...
  &TypeInfo__gEfiEraseBlockProtocolGuid,
  &TypeInfo__EFI_ERASE_BLOCK_PROTOCOL,
  &TypeInfo__EFI_BLOCK_ERASE,
  &TypeInfo__EFI_ERASE_BLOCK_PROTOCOL_STAR,
  &TypeInfo__EFI_ERASE_BLOCK_TOKEN_STAR,
  &TypeInfo__EFI_ERASE_BLOCK_TOKEN,
  NULL
};