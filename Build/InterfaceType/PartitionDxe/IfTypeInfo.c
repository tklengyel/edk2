...
typedef struct _TYPE__EFI_PARTITION_INFO_PROTOCOL{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const UINTN StructFieldNum;
  ...
  const CHAR8* StructFieldName_5;
  const CHAR8* StructFieldTypeName_5;
} TYPE__EFI_PARTITION_INFO_PROTOCOL;

TYPE__EFI_PARTITION_INFO_PROTOCOL TypeInfo__EFI_PARTITION_INFO_PROTOCOL = {
  .TypeName = "EFI_PARTITION_INFO_PROTOCOL",
  .TypeClass = TYPE_CLASS_STRUCTURE,
  .TypeSize = sizeof(EFI_PARTITION_INFO_PROTOCOL),
  .StructFieldNum = 5,
  .StructFieldName_1 = "Revision",
  .StructFieldTypeName_1 = "UINT32",
  .StructFieldName_2 = "Type",
  .StructFieldTypeName_2 = "UINT32",
  .StructFieldName_3 = "System",
  .StructFieldTypeName_3 = "UINT8",
  .StructFieldName_4 = "Reserved",
  .StructFieldTypeName_4 = "UINT8[7]",
  .StructFieldName_5 = "Info",
  .StructFieldTypeName_5 = "union(anonymousunionat/home/jshi19/wksp_efi/simicsx58_bios_udk2017-simicsx58_edk2/MdePkg/Include/Protocol/PartitionInfo.h:55:3)"
};


typedef struct _TYPE__UINT8_ARRAY_7{
  const CHAR8* TypeName;
  const UINTN TypeClass;
  const UINTN TypeSize;
  const CHAR8* ElementTypeName;
...
TYPE__UINT8_ARRAY_7 TypeInfo__UINT8_ARRAY_7 = {
  .TypeName = "UINT8[7]",
  .TypeClass = TYPE_CLASS_TYPEDEF,
  .TypeSize = sizeof(UINT8[7]),
  .ElementTypeName = "UINT8"
};
...
void *TypeInfoList[] = {
  ...
  &TypeInfo__gEfiPartitionInfoProtocolGuid,
  &TypeInfo__EFI_PARTITION_INFO_PROTOCOL,
  &TypeInfo__UINT8_ARRAY_7,
  NULL
};